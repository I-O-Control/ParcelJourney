...
`)}var r_={[wl]:"Linear",[Al]:"Reinhard",[Cl]:"Cineon",[Rl]:"ACESFilmic",[Il]:"AgX",[Ll]:"Neutral",[Pl]:"Custom"};function a_(i,t){let e=r_[t];return e===void 0?(qt("WebGLProgram: Unsupported toneMapping:",t),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}var wo=new I;function o_(){ae.getLuminanceCoefficients(wo);let i=wo.x.toFixed(4),t=wo.y.toFixed(4),e=wo.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+p);let A=w+m+a,v=w+p+o,b=su(s,s.VERTEX_SHADER,A),E=su(s,s.FRAGMENT_SHADER,v);s.attachShader(M,b),s.attachShader(M,E),e.index0AttributeName!==void 0?s.bindAttribLocation(M,0,e.index0AttributeName):e.hasPositionAttribute===!0&&s.bindAttribLocation(M,0,"position"),s.linkProgram(M);function L(F){if(i.debug.checkShaderErrors){let H=s.getProgramInfoLog(M)||"",W=s.getShaderInfoLog(b)||"",U=s.getShaderInfoLog(E)||"",V=H.trim(),K=W.trim(),q=U.trim(),rt=!0,Y=!0;if(s.getProgramParameter(M,s.LINK_STATUS)===!1)if(rt=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,M,b,E);else{let nt=au(s,b,"vertex"),st=au(s,E,"fragment");jt("WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(M,s.VALIDATE_STATUS)+`
...
}`,cc=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,e){if(this.texture===null){let n=new Xs(t.texture);(t.depthNear!==e.depthNear||t.depthFar!==e.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=n}}getMesh(t){if(this.texture!==null&&this.mesh===null){let e=t.cameras[0].viewport,n=new rn({vertexShader:q_,fragmentShader:Y_,uniforms:{depthColor:{value:this.texture},depthWidth:{value:e.z},depthHeight:{value:e.w}}});this.mesh=new be(new er(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},hc=class extends xn{constructor(t,e){super();let n=this,s=null,r=1,a=null,o="local-floor",l=1,c=null,h=null,f=null,u=null,d=null,_=null,M=typeof XRWebGLBinding<"u",m=new cc,p={},w=e.getContextAttributes(),A=null,v=null,b=[],E=[],L=new ut,y=null,T=null,C=new Ye;C.viewport=new ve;let F=new Ye;F.viewport=new ve;let H=[C,F],W=new Na,U=null,V=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(X){let it=b[X];return it===void 0&&(it=new es,b[X]=it),it.getTargetRaySpace()},this.getControllerGrip=function(X){let it=b[X];return it===void 0&&(it=new es,b[X]=it),it.getGripSpace()},this.getHand=function(X){let it=b[X];return it===void 0&&(it=new es,b[X]=it),it.getHandSpace()};function K(X){let it=E.indexOf(X.inputSource);if(it===-1)return;let Et=b[it];Et!==void 0&&(Et.update(X.inputSource,X.frame,c||a),Et.dispatchEvent({type:X.type,data:X.inputSource}))}function q(){s.removeEventListener("select",K),s.removeEventListener("selectstart",K),s.removeEventListener("selectend",K),s.removeEventListener("squeeze",K),s.removeEventListener("squeezestart",K),s.removeEventListener("squeezeend",K),s.removeEventListener("end",q),s.removeEventListener("inputsourceschange",rt);for(let X=0;X<b.length;X++){let it=E[X];it!==null&&(E[X]=null,b[X].disconnect(it))}U=null,V=null,m.reset();for(let X in p)delete p[X];if(t.setRenderTarget(A),d=null,u=null,f=null,s=null,v=null,$t.stop(),n.isPresenting=!1,t.setPixelRatio(y),t.setSize(L.width,L.height,!1),T!==null){let X=T.camera;X.fov=T.fov,X.zoom=T.zoom,X.updateProjectionMatrix(),T=null}n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(X){r=X,n.isPresenting===!0&&qt("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(X){o=X,n.isPresenting===!0&&qt("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(X){c=X},this.getBaseLayer=function(){return u!==null?u:d},this.getBinding=function(){return f===null&&M&&(f=new XRWebGLBinding(s,e)),f},this.getFrame=function(){return _},this.getSession=function(){return s},this.setSession=async function(X){if(s=X,s!==null){if(A=t.getRenderTarget(),s.addEventListener("select",K),s.addEventListener("selectstart",K),s.addEventListener("selectend",K),s.addEventListener("squeeze",K),s.addEventListener("squeezestart",K),s.addEventListener("squeezeend",K),s.addEventListener("end",q),s.addEventListener("inputsourceschange",rt),w.xrCompatible!==!0&&await e.makeXRCompatible(),y=t.getPixelRatio(),t.getSize(L),M&&"createProjectionLayer"in XRWebGLBinding.prototype){let Et=null,Gt=null,At=null;w.depth&&(At=w.stencil?e.DEPTH24_STENCIL8:e.DEPTH_COMPONENT24,Et=w.stencil?hi:wn,Gt=w.stencil?ds:Mn);let Yt={colorFormat:e.RGBA8,depthFormat:At,scaleFactor:r};f=this.getBinding(),u=f.createProjectionLayer(Yt),s.updateRenderState({layers:[u]}),t.setPixelRatio(1),t.setSize(u.textureWidth,u.textureHeight,!1),v=new Je(u.textureWidth,u.textureHeight,{format:fn,type:$e,depthTexture:new ti(u.textureWidth,u.textureHeight,Gt,void 0,void 0,void 0,void 0,void 0,void 0,Et),stencilBuffer:w.stencil,colorSpace:t.outputColorSpace,samples:w.antialias?4:0,resolveDepthBuffer:u.ignoreDepthValues===!1,resolveStencilBuffer:u.ignoreDepthValues===!1,storeMultisampledDepthBuffer:u.ignoreDepthValues===!1,storeMultisampledStencilBuffer:u.ignoreDepthValues===!1})}else{let Et={antialias:w.antialias,alpha:!0,depth:w.depth,stencil:w.stencil,framebufferScaleFactor:r};d=new XRWebGLLayer(s,e,Et),s.updateRenderState({baseLayer:d}),t.setPixelRatio(1),t.setSize(d.framebufferWidth,d.framebufferHeight,!1),v=new Je(d.framebufferWidth,d.framebufferHeight,{format:fn,type:$e,colorSpace:t.outputColorSpace,stencilBuffer:w.stencil,resolveDepthBuffer:d.ignoreDepthValues===!1,resolveStencilBuffer:d.ignoreDepthValues===!1,storeMultisampledDepthBuffer:d.ignoreDepthValues===!1,storeMultisampledStencilBuffer:d.ignoreDepthValues===!1})}v.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await s.requestReferenceSpace(o),$t.setContext(s),$t.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return m.getDepthTexture()};function rt(X){for(let it=0;it<X.removed.length;it++){let Et=X.removed[it],Gt=E.indexOf(Et);Gt>=0&&(E[Gt]=null,b[Gt].disconnect(Et))}for(let it=0;it<X.added.length;it++){let Et=X.added[it],Gt=E.indexOf(Et);if(Gt===-1){for(let Yt=0;Yt<b.length;Yt++)if(Yt>=E.length){E.push(Et),Gt=Yt;break}else if(E[Yt]===null){E[Yt]=Et,Gt=Yt;break}if(Gt===-1)break}let At=b[Gt];At&&At.connect(Et)}}let Y=new I,nt=new I;function st(X,it,Et){Y.setFromMatrixPosition(it.matrixWorld),nt.setFromMatrixPosition(Et.matrixWorld);let Gt=Y.distanceTo(nt),At=it.projectionMatrix.elements,Yt=Et.projectionMatrix.elements,It=At[14]/(At[10]-1),J=At[14]/(At[10]+1),ot=(At[9]+1)/At[5],ct=(At[9]-1)/At[5],ht=(At[8]-1)/At[0],mt=(Yt[8]+1)/Yt[0],Ht=It*ht,Vt=It*mt,Zt=Gt/(-ht+mt),Kt=Zt*-ht;if(it.matrixWorld.decompose(X.position,X.quaternion,X.scale),X.translateX(Kt),X.translateZ(Zt),X.matrixWorld.compose(X.position,X.quaternion,X.scale),X.matrixWorldInverse.copy(X.matrixWorld).invert(),At[10]===-1)X.projectionMatrix.copy(it.projectionMatrix),X.projectionMatrixInverse.copy(it.projectionMatrixInverse);else{let P=It+Zt,ne=J+Zt,Wt=Ht-Kt,S=Vt+(Gt-Kt),g=ot*J/ne*P,B=ct*J/ne*P;X.projectionMatrix.makePerspective(Wt,S,g,B,P,ne),X.projectionMatrixInverse.copy(X.projectionMatrix).invert()}}function Ot(X,it){it===null?X.matrixWorld.copy(X.matrix):X.matrixWorld.multiplyMatrices(it.matrixWorld,X.matrix),X.matrixWorldInverse.copy(X.matrixWorld).invert()}this.updateCamera=function(X){if(s===null)return;let it=X.near,Et=X.far;m.texture!==null&&(m.depthNear>0&&(it=m.depthNear),m.depthFar>0&&(Et=m.depthFar)),W.near=F.near=C.near=it,W.far=F.far=C.far=Et,(U!==W.near||V!==W.far)&&(s.updateRenderState({depthNear:W.near,depthFar:W.far}),U=W.near,V=W.far),W.layers.mask=X.layers.mask|6,C.layers.mask=W.layers.mask&-5,F.layers.mask=W.layers.mask&-3;let Gt=X.parent,At=W.cameras;Ot(W,Gt);for(let Yt=0;Yt<At.length;Yt++)Ot(At[Yt],Gt);At.length===2?st(W,C,F):W.projectionMatrix.copy(C.projectionMatrix),T===null&&X.isPerspectiveCamera&&(T={camera:X,fov:X.fov,zoom:X.zoom}),Lt(X,W,Gt)};function Lt(X,it,Et){Et===null?X.matrix.copy(it.matrixWorld):(X.matrix.copy(Et.matrixWorld),X.matrix.invert(),X.matrix.multiply(it.matrixWorld)),X.matrix.decompose(X.position,X.quaternion,X.scale),X.updateMatrixWorld(!0),X.projectionMatrix.copy(it.projectionMatrix),X.projectionMatrixInverse.copy(it.projectionMatrixInverse),X.isPerspectiveCamera&&(X.fov=ji*2*Math.atan(1/X.projectionMatrix.elements[5]),X.zoom=1)}this.getCamera=function(){return W},this.getFoveation=function(){if(!(u===null&&d===null))return l},this.setFoveation=function(X){l=X,u!==null&&(u.fixedFoveation=X),d!==null&&d.fixedFoveation!==void 0&&(d.fixedFoveation=X)},this.hasDepthSensing=function(){return m.texture!==null},this.getDepthSensingMesh=function(){return m.getMesh(W)},this.getCameraTexture=function(X){return p[X]};let le=null;function Bt(X,it){if(h=it.getViewerPose(c||a),_=it,h!==null){let Et=h.views;d!==null&&(t.setRenderTargetFramebuffer(v,d.framebuffer),t.setRenderTarget(v));let Gt=!1;Et.length!==W.cameras.length&&(W.cameras.length=0,Gt=!0);for(let J=0;J<Et.length;J++){let ot=Et[J],ct=null;if(d!==null)ct=d.getViewport(ot);else{let mt=f.getViewSubImage(u,ot);ct=mt.viewport,J===0&&(t.setRenderTargetTextures(v,mt.colorTexture,mt.depthStencilTexture),t.setRenderTarget(v))}let ht=H[J];ht===void 0&&(ht=new Ye,ht.layers.enable(J),ht.viewport=new ve,H[J]=ht),ht.matrix.fromArray(ot.transform.matrix),ht.matrix.decompose(ht.position,ht.quaternion,ht.scale),ht.projectionMatrix.fromArray(ot.projectionMatrix),ht.projectionMatrixInverse.copy(ht.projectionMatrix).invert(),ht.viewport.set(ct.x,ct.y,ct.width,ct.height),J===0&&(W.matrix.copy(ht.matrix),W.matrix.decompose(W.position,W.quaternion,W.scale)),Gt===!0&&W.cameras.push(ht)}let At=s.enabledFeatures;if(At&&At.includes("depth-sensing")&&s.depthUsage=="gpu-optimized"&&M){f=n.getBinding();let J=f.getDepthInformation(Et[0]);J&&J.isValid&&J.texture&&m.init(J,s.renderState)}if(At&&At.includes("camera-access")&&M){t.state.unbindTexture(),f=n.getBinding();for(let J=0;J<Et.length;J++){let ot=Et[J].camera;if(ot){let ct=p[ot];ct||(ct=new Xs,p[ot]=ct);let ht=f.getCameraImage(ot);ct.sourceTexture=ht}}}}for(let Et=0;Et<b.length;Et++){let Gt=E[Et],At=b[Et];Gt!==null&&At!==void 0&&At.update(Gt,it,c||a)}le&&le(X,it),it.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:it}),_=null}let $t=new mu;$t.setAnimationLoop(Bt),this.setAnimationLoop=function(X){le=X},this.dispose=function(){}}},Z_=new fe,Mu=new ee;Mu.set(-1,0,0,0,1,0,0,0,1);function J_(i,t){function e(m,p){m.matrixAutoUpdate===!0&&m.updateMatrix(),p.value.copy(m.matrix)}function n(m,p){p.color.getRGB(m.fogColor.value,ql(i)),p.isFog?(m.fogNear.value=p.near,m.fogFar.value=p.far):p.isFogExp2&&(m.fogDensity.value=p.density)}function s(m,p,w,A,v){p.isNodeMaterial?p.uniformsNeedUpdate=!1:p.isMeshBasicMaterial?r(m,p):p.isMeshLambertMaterial?(r(m,p),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)):p.isMeshToonMaterial?(r(m,p),f(m,p)):p.isMeshPhongMaterial?(r(m,p),h(m,p),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)):p.isMeshStandardMaterial?(r(m,p),u(m,p),p.isMeshPhysicalMaterial&&d(m,p,v)):p.isMeshMatcapMaterial?(r(m,p),_(m,p)):p.isMeshDepthMaterial?r(m,p):p.isMeshDistanceMaterial?(r(m,p),M(m,p)):p.isMeshNormalMaterial?r(m,p):p.isLineBasicMaterial?(a(m,p),p.isLineDashedMaterial&&o(m,p)):p.isPointsMaterial?l(m,p,w,A):p.isSpriteMaterial?c(m,p):p.isShadowMaterial?(m.color.value.copy(p.color),m.opacity.value=p.opacity):p.isShaderMaterial&&(p.uniformsNeedUpdate=!1)}function r(m,p){m.opacity.value=p.opacity,p.color&&m.diffuse.value.copy(p.color),p.emissive&&m.emissive.value.copy(p.emissive).multiplyScalar(p.emissiveIntensity),p.map&&(m.map.value=p.map,e(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,e(p.alphaMap,m.alphaMapTransform)),p.bumpMap&&(m.bumpMap.value=p.bumpMap,e(p.bumpMap,m.bumpMapTransform),m.bumpScale.value=p.bumpScale,p.side===Xe&&(m.bumpScale.value*=-1)),p.normalMap&&(m.normalMap.value=p.normalMap,e(p.normalMap,m.normalMapTransform),m.normalScale.value.copy(p.normalScale),p.side===Xe&&m.normalScale.value.negate()),p.displacementMap&&(m.displacementMap.value=p.displacementMap,e(p.displacementMap,m.displacementMapTransform),m.displacementScale.value=p.displacementScale,m.displacementBias.value=p.displacementBias),p.emissiveMap&&(m.emissiveMap.value=p.emissiveMap,e(p.emissiveMap,m.emissiveMapTransform)),p.specularMap&&(m.specularMap.value=p.specularMap,e(p.specularMap,m.specularMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest);let w=t.get(p),A=w.envMap,v=w.envMapRotation;A&&(m.envMap.value=A,m.envMapRotation.value.setFromMatrix4(Z_.makeRotationFromEuler(v)).transpose(),A.isCubeTexture&&A.isRenderTargetTexture===!1&&m.envMapRotation.value.premultiply(Mu),m.reflectivity.value=p.reflectivity,m.ior.value=p.ior,m.refractionRatio.value=p.refractionRatio),p.lightMap&&(m.lightMap.value=p.lightMap,m.lightMapIntensity.value=p.lightMapIntensity,e(p.lightMap,m.lightMapTransform)),p.aoMap&&(m.aoMap.value=p.aoMap,m.aoMapIntensity.value=p.aoMapIntensity,e(p.aoMap,m.aoMapTransform))}function a(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,p.map&&(m.map.value=p.map,e(p.map,m.mapTransform))}function o(m,p){m.dashSize.value=p.dashSize,m.totalSize.value=p.dashSize+p.gapSize,m.scale.value=p.scale}function l(m,p,w,A){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.size.value=p.size*w,m.scale.value=A*.5,p.map&&(m.map.value=p.map,e(p.map,m.uvTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,e(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function c(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.rotation.value=p.rotation,p.map&&(m.map.value=p.map,e(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,e(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function h(m,p){m.specular.value.copy(p.specular),m.shininess.value=Math.max(p.shininess,1e-4)}function f(m,p){p.gradientMap&&(m.gradientMap.value=p.gradientMap)}function u(m,p){m.metalness.value=p.metalness,p.metalnessMap&&(m.metalnessMap.value=p.metalnessMap,e(p.metalnessMap,m.metalnessMapTransform)),m.roughness.value=p.roughness,p.roughnessMap&&(m.roughnessMap.value=p.roughnessMap,e(p.roughnessMap,m.roughnessMapTransform)),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)}function d(m,p,w){m.ior.value=p.ior,p.sheen>0&&(m.sheenColor.value.copy(p.sheenColor).multiplyScalar(p.sheen),m.sheenRoughness.value=p.sheenRoughness,p.sheenColorMap&&(m.sheenColorMap.value=p.sheenColorMap,e(p.sheenColorMap,m.sheenColorMapTransform)),p.sheenRoughnessMap&&(m.sheenRoughnessMap.value=p.sheenRoughnessMap,e(p.sheenRoughnessMap,m.sheenRoughnessMapTransform))),p.clearcoat>0&&(m.clearcoat.value=p.clearcoat,m.clearcoatRoughness.value=p.clearcoatRoughness,p.clearcoatMap&&(m.clearcoatMap.value=p.clearcoatMap,e(p.clearcoatMap,m.clearcoatMapTransform)),p.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=p.clearcoatRoughnessMap,e(p.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),p.clearcoatNormalMap&&(m.clearcoatNormalMap.value=p.clearcoatNormalMap,e(p.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(p.clearcoatNormalScale),p.side===Xe&&m.clearcoatNormalScale.value.negate())),p.dispersion>0&&(m.dispersion.value=p.dispersion),p.retroreflectivity>0&&(m.retroreflectivity.value=p.retroreflectivity),p.iridescence>0&&(m.iridescence.value=p.iridescence,m.iridescenceIOR.value=p.iridescenceIOR,m.iridescenceThicknessMinimum.value=p.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=p.iridescenceThicknessRange[1],p.iridescenceMap&&(m.iridescenceMap.value=p.iridescenceMap,e(p.iridescenceMap,m.iridescenceMapTransform)),p.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=p.iridescenceThicknessMap,e(p.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),p.transmission>0&&(m.transmission.value=p.transmission,m.transmissionSamplerMap.value=w.texture,m.transmissionSamplerSize.value.set(w.width,w.height),p.transmissionMap&&(m.transmissionMap.value=p.transmissionMap,e(p.transmissionMap,m.transmissionMapTransform)),m.thickness.value=p.thickness,p.thicknessMap&&(m.thicknessMap.value=p.thicknessMap,e(p.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=p.attenuationDistance,m.attenuationColor.value.copy(p.attenuationColor)),p.anisotropy>0&&(m.anisotropyVector.value.set(p.anisotropy*Math.cos(p.anisotropyRotation),p.anisotropy*Math.sin(p.anisotropyRotation)),p.anisotropyMap&&(m.anisotropyMap.value=p.anisotropyMap,e(p.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=p.specularIntensity,m.specularColor.value.copy(p.specularColor),p.specularColorMap&&(m.specularColorMap.value=p.specularColorMap,e(p.specularColorMap,m.specularColorMapTransform)),p.specularIntensityMap&&(m.specularIntensityMap.value=p.specularIntensityMap,e(p.specularIntensityMap,m.specularIntensityMapTransform))}function _(m,p){p.matcap&&(m.matcap.value=p.matcap)}function M(m,p){let w=t.get(p).light;m.referencePosition.value.setFromMatrixPosition(w.matrixWorld),m.nearDistance.value=w.shadow.camera.near,m.farDistance.value=w.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:s}}function $_(i,t,e,n){let s={},r={},a=[],o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function l(v,b){let E=b.program;n.uniformBlockBinding(v,E)}function c(v,b){let E=s[v.id];E===void 0&&(m(v),E=h(v),s[v.id]=E,v.addEventListener("dispose",w));let L=b.program;n.updateUBOMapping(v,L);let y=t.render.frame;r[v.id]!==y&&(u(v),r[v.id]=y)}function h(v){let b=f();v.__bindingPointIndex=b;let E=i.createBuffer(),L=v.__size,y=v.usage;return i.bindBuffer(i.UNIFORM_BUFFER,E),i.bufferData(i.UNIFORM_BUFFER,L,y),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,b,E),E}function f(){for(let v=0;v<o;v++)if(a.indexOf(v)===-1)return a.push(v),v;return jt("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function u(v){let b=s[v.id],E=v.uniforms,L=v.__cache;i.bindBuffer(i.UNIFORM_BUFFER,b);for(let y=0,T=E.length;y<T;y++){let C=E[y];if(Array.isArray(C))for(let F=0,H=C.length;F<H;F++)d(C[F],y,F,L);else d(C,y,0,L)}i.bindBuffer(i.UNIFORM_BUFFER,null)}function d(v,b,E,L){if(M(v,b,E,L)===!0){let y=v.__offset,T=v.value;if(Array.isArray(T)){let C=0;for(let F=0;F<T.length;F++){let H=T[F],W=p(H);_(H,v.__data,C),typeof H!="number"&&typeof H!="boolean"&&!H.isMatrix3&&!ArrayBuffer.isView(H)&&(C+=W.storage/Float32Array.BYTES_PER_ELEMENT)}}else _(T,v.__data,0);i.bufferSubData(i.UNIFORM_BUFFER,y,v.__data)}}function _(v,b,E){typeof v=="number"||typeof v=="boolean"?b[0]=v:v.isMatrix3?(b[0]=v.elements[0],b[1]=v.elements[1],b[2]=v.elements[2],b[3]=0,b[4]=v.elements[3],b[5]=v.elements[4],b[6]=v.elements[5],b[7]=0,b[8]=v.elements[6],b[9]=v.elements[7],b[10]=v.elements[8],b[11]=0):ArrayBuffer.isView(v)?b.set(new v.constructor(v.buffer,v.byteOffset,b.length)):v.toArray(b,E)}function M(v,b,E,L){let y=v.value,T=b+"_"+E;if(L[T]===void 0)return typeof y=="number"||typeof y=="boolean"?L[T]=y:ArrayBuffer.isView(y)?L[T]=y.slice():L[T]=y.clone(),!0;{let C=L[T];if(typeof y=="number"||typeof y=="boolean"){if(C!==y)return L[T]=y,!0}else{if(ArrayBuffer.isView(y))return!0;if(C.equals(y)===!1)return C.copy(y),!0}}return!1}function m(v){let b=v.uniforms,E=0,L=16;for(let T=0,C=b.length;T<C;T++){let F=Array.isArray(b[T])?b[T]:[b[T]];for(let H=0,W=F.length;H<W;H++){let U=F[H],V=Array.isArray(U.value)?U.value:[U.value];for(let K=0,q=V.length;K<q;K++){let rt=V[K],Y=p(rt),nt=E%L,st=nt%Y.boundary,Ot=nt+st;E+=st,Ot!==0&&L-Ot<Y.storage&&(E+=L-Ot),U.__data=new Float32Array(Y.storage/Float32Array.BYTES_PER_ELEMENT),U.__offset=E,E+=Y.storage}}}let y=E%L;return y>0&&(E+=L-y),v.__size=E,v.__cache={},this}function p(v){let b={boundary:0,storage:0};return typeof v=="number"||typeof v=="boolean"?(b.boundary=4,b.storage=4):v.isVector2?(b.boundary=8,b.storage=8):v.isVector3||v.isColor?(b.boundary=16,b.storage=12):v.isVector4?(b.boundary=16,b.storage=16):v.isMatrix3?(b.boundary=48,b.storage=48):v.isMatrix4?(b.boundary=64,b.storage=64):v.isTexture?qt("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(v)?(b.boundary=16,b.storage=v.byteLength):qt("WebGLRenderer: Unsupported uniform value type.",v),b}function w(v){let b=v.target;b.removeEventListener("dispose",w);let E=a.indexOf(b.__bindingPointIndex);a.splice(E,1),i.deleteBuffer(s[b.id]),delete s[b.id],delete r[b.id]}function A(){for(let v in s)i.deleteBuffer(s[v]);a=[],s={},r={}}return{bind:l,update:c,dispose:A}}var K_=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),Rn=null;function j_(){return Rn===null&&(Rn=new Vs(K_,16,16,ui,Sn),Rn.name="DFG_LUT",Rn.minFilter=Ne,Rn.magFilter=Ne,Rn.wrapS=Tn,Rn.wrapT=Tn,Rn.generateMipmaps=!1,Rn.needsUpdate=!0),Rn}var Ro=class{constructor(t={}){let{canvas:e=Fh(),context:n=null,depth:s=!0,stencil:r=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:f=!1,reversedDepthBuffer:u=!1,outputBufferType:d=$e}=t;this.isWebGLRenderer=!0;let _;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");_=n.getContextAttributes().alpha}else _=a;let M=d,m=new Set([Wa,Ha,Ga]),p=new Set([$e,Mn,us,ds,za,ka]),w=new Uint32Array(4),A=new Int32Array(4),v=new I,b=null,E=null,L=[],y=[],T=null;this.domElement=e,this.debug={checkShaderErrors:!0,diagnostics:{keywords:!1},onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=vn,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let C=this,F=!1,H=null,W=null,U=null,V=null;this._outputColorSpace=He;let K=0,q=0,rt=null,Y=-1,nt=null,st=new ve,Ot=new ve,Lt=null,le=new se(0),Bt=0,$t=e.width,X=e.height,it=1,Et=null,Gt=null,At=new ve(0,0,$t,X),Yt=new ve(0,0,$t,X),It=!1,J=new is,ot=!1,ct=!1,ht=new fe,mt=new I,Ht=new ve,Vt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},Zt=!1;function Kt(){return rt===null?it:1}let P=n;function ne(x,R){return e.getContext(x,R)}let Wt,S,g,B,G,Z,dt,_t,$,Q,gt,Ft,St,Mt,kt,Xt,te,N,xt,tt,yt,Ct,et;try{let x={alpha:!0,depth:s,stencil:r,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:h,failIfMajorPerformanceCaveat:f};if("setAttribute"in e&&e.setAttribute("data-engine",`three.js r${"186"}`),e.addEventListener("webglcontextlost",de,!1),e.addEventListener("webglcontextrestored",ce,!1),e.addEventListener("webglcontextcreationerror",ze,!1),P===null){let R="webgl2";if(P=ne(R,x),P===null)throw ne(R)?new Error("THREE.WebGLRenderer: Error creating WebGL context with your selected attributes."):new Error("THREE.WebGLRenderer: Error creating WebGL context.")}zt()}catch(x){throw e.removeEventListener("webglcontextlost",de,!1),e.removeEventListener("webglcontextrestored",ce,!1),e.removeEventListener("webglcontextcreationerror",ze,!1),jt("WebGLRenderer: "+x.message),x}function zt(){Wt=new rg(P),Wt.init(),yt=new X_(P,Wt),S=new Jm(P,Wt,t,yt),g=new H_(P,Wt),S.reversedDepthBuffer&&u&&g.buffers.depth.setReversed(!0),W=P.createFramebuffer(),U=P.createFramebuffer(),V=P.createFramebuffer(),B=new lg(P),G=new R_,Z=new W_(P,Wt,g,G,S,yt,B),dt=new sg(C),_t=new hf(P),Ct=new Ym(P,_t),$=new ag(P,_t,B,Ct),Q=new hg(P,$,_t,Ct,B),N=new cg(P,S,Z),kt=new $m(G),gt=new C_(C,dt,Wt,S,Ct,kt),Ft=new J_(C,G),St=new I_,Mt=new O_(Wt),te=new qm(C,dt,g,Q,_,l),Xt=new G_(C,Q,S),et=new $_(P,B,S,g),xt=new Zm(P,Wt,B),tt=new og(P,Wt,B),B.programs=gt.programs,C.capabilities=S,C.extensions=Wt,C.properties=G,C.renderLists=St,C.shadowMap=Xt,C.state=g,C.info=B}M!==$e&&(T=new dg(M,e.width,e.height,o,s,r));let Ut=new hc(C,P);this.xr=Ut,this.getContext=function(){return P},this.getContextAttributes=function(){return P.getContextAttributes()},this.forceContextLoss=function(){let x=Wt.get("WEBGL_lose_context");x&&x.loseContext()},this.forceContextRestore=function(){let x=Wt.get("WEBGL_lose_context");x&&x.restoreContext()},this.getPixelRatio=function(){return it},this.setPixelRatio=function(x){x!==void 0&&(it=x,this.setSize($t,X,!1))},this.getSize=function(x){return x.set($t,X)},this.setSize=function(x,R,k=!0){if(Ut.isPresenting){qt("WebGLRenderer: Can't change size while VR device is presenting.");return}$t=x,X=R,e.width=Math.floor(x*it),e.height=Math.floor(R*it),k===!0&&(e.style.width=x+"px",e.style.height=R+"px"),T!==null&&T.setSize(e.width,e.height),this.setViewport(0,0,x,R)},this.getDrawingBufferSize=function(x){return x.set($t*it,X*it).floor()},this.setDrawingBufferSize=function(x,R,k){$t=x,X=R,it=k,e.width=Math.floor(x*k),e.height=Math.floor(R*k),this.setViewport(0,0,x,R)},this.setEffects=function(x){if(M===$e){jt("WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(x){for(let R=0;R<x.length;R++)if(x[R].isOutputPass===!0){qt("WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}T.setEffects(x||[])},this.getCurrentViewport=function(x){return x.copy(st)},this.getViewport=function(x){return x.copy(At)},this.setViewport=function(x,R,k,z){x.isVector4?At.set(x.x,x.y,x.z,x.w):At.set(x,R,k,z),g.viewport(st.copy(At).multiplyScalar(it).round())},this.getScissor=function(x){return x.copy(Yt)},this.setScissor=function(x,R,k,z){x.isVector4?Yt.set(x.x,x.y,x.z,x.w):Yt.set(x,R,k,z),g.scissor(Ot.copy(Yt).multiplyScalar(it).round())},this.getScissorTest=function(){return It},this.setScissorTest=function(x){g.setScissorTest(It=x)},this.setOpaqueSort=function(x){Et=x},this.setTransparentSort=function(x){Gt=x},this.getClearColor=function(x){return x.copy(te.getClearColor())},this.setClearColor=function(){te.setClearColor(...arguments)},this.getClearAlpha=function(){return te.getClearAlpha()},this.setClearAlpha=function(){te.setClearAlpha(...arguments)},this.clear=function(x=!0,R=!0,k=!0){let z=0;if(x){let O=!1;if(rt!==null){let lt=rt.texture.format;O=m.has(lt)}if(O){let lt=rt.texture.type,ft=p.has(lt),pt=te.getClearColor(),Tt=te.getClearAlpha(),Dt=pt.r,Jt=pt.g,Qt=pt.b;ft?(w[0]=Dt,w[1]=Jt,w[2]=Qt,w[3]=Tt,P.clearBufferuiv(P.COLOR,0,w)):(A[0]=Dt,A[1]=Jt,A[2]=Qt,A[3]=Tt,P.clearBufferiv(P.COLOR,0,A))}else z|=P.COLOR_BUFFER_BIT}R&&(z|=P.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),k&&(z|=P.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),z!==0&&P.clear(z)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(x){x.setRenderer(this),H=x},this.dispose=function(){e.removeEventListener("webglcontextlost",de,!1),e.removeEventListener("webglcontextrestored",ce,!1),e.removeEventListener("webglcontextcreationerror",ze,!1),te.dispose(),St.dispose(),Mt.dispose(),G.dispose(),dt.dispose(),Q.dispose(),Ct.dispose(),et.dispose(),gt.dispose(),Ut.dispose(),Ut.removeEventListener("sessionstart",Sr),Ut.removeEventListener("sessionend",br),In.stop()};function de(x){x.preventDefault(),Gl("WebGLRenderer: Context Lost."),F=!0}function ce(){Gl("WebGLRenderer: Context Restored."),F=!1;let x=B.autoReset,R=Xt.enabled,k=Xt.autoUpdate,z=Xt.needsUpdate,O=Xt.type;zt(),B.autoReset=x,Xt.enabled=R,Xt.autoUpdate=k,Xt.needsUpdate=z,Xt.type=O}function ze(x){jt("WebGLRenderer: A WebGL context could not be created. Reason: ",x.statusMessage)}function ke(x){let R=x.target;R.removeEventListener("dispose",ke),_s(R)}function _s(x){Ri(x),G.remove(x)}function Ri(x){let R=G.get(x).programs;R!==void 0&&(R.forEach(function(k){gt.releaseProgram(k)}),x.isShaderMaterial&&gt.releaseShaderCache(x))}this.renderBufferDirect=function(x,R,k,z,O,lt){R===null&&(R=Vt);let ft=O.isMesh&&O.matrixWorld.determinantAffine()<0,pt=j(x,R,k,z,O);g.setMaterial(z,ft);let Tt=k.index,Dt=1;if(z.wireframe===!0){if(Tt=$.getWireframeAttribute(k),Tt===void 0)return;Dt=2}let Jt=k.drawRange,Qt=k.attributes.position,bt=Jt.start*Dt,oe=(Jt.start+Jt.count)*Dt;lt!==null&&(bt=Math.max(bt,lt.start*Dt),oe=Math.min(oe,(lt.start+lt.count)*Dt)),Tt!==null?(bt=Math.max(bt,0),oe=Math.min(oe,Tt.count)):Qt!=null&&(bt=Math.max(bt,0),oe=Math.min(oe,Qt.count));let Ee=oe-bt;if(Ee<0||Ee===1/0)return;Ct.setup(O,z,pt,k,Tt);let xe,ge=xt;if(Tt!==null&&(xe=_t.get(Tt),ge=tt,ge.setIndex(xe)),O.isMesh)z.wireframe===!0?(g.setLineWidth(z.wireframeLinewidth*Kt()),ge.setMode(P.LINES)):ge.setMode(P.TRIANGLES);else if(O.isLine){let Ue=z.linewidth;Ue===void 0&&(Ue=1),g.setLineWidth(Ue*Kt()),O.isLineSegments?ge.setMode(P.LINES):O.isLineLoop?ge.setMode(P.LINE_LOOP):ge.setMode(P.LINE_STRIP)}else O.isPoints?ge.setMode(P.POINTS):O.isSprite&&ge.setMode(P.TRIANGLES);if(O.isBatchedMesh)if(Wt.get("WEBGL_multi_draw"))ge.renderMultiDraw(O._multiDrawStarts,O._multiDrawCounts,O._multiDrawCount);else{let Ue=O._multiDrawStarts,Nt=O._multiDrawCounts,Ve=O._multiDrawCount,he=Tt?_t.get(Tt).bytesPerElement:1,on=G.get(z).currentProgram.getUniforms();for(let bn=0;bn<Ve;bn++)on.setValue(P,"_gl_DrawID",bn),ge.render(Ue[bn]/he,Nt[bn])}else if(O.isInstancedMesh)ge.renderInstances(bt,Ee,O.count);else if(k.isInstancedBufferGeometry){let Ue=k._maxInstanceCount!==void 0?k._maxInstanceCount:1/0,Nt=Math.min(k.instanceCount,Ue);ge.renderInstances(bt,Ee,Nt)}else ge.render(bt,Ee)};function Pi(x,R,k,z){H!==null&&x.isNodeMaterial&&H.setObject(z,x),ot===!0&&kt.setState(x,k,!1),x.transparent===!0&&x.side===un&&x.forceSinglePass===!1?(x.side=Xe,x.needsUpdate=!0,mi(x,R,z),x.side=oi,x.needsUpdate=!0,mi(x,R,z),x.side=un):mi(x,R,z)}this.compile=function(x,R,k=null){k===null&&(k=x),H!==null&&H.renderStart(x,R,k),E=Mt.get(k),E.init(R),y.push(E),k.traverseVisible(function(O){O.isLight&&O.layers.test(R.layers)&&(E.pushLight(O),O.castShadow&&E.pushShadow(O))}),x!==k&&x.traverseVisible(function(O){O.isLight&&O.layers.test(R.layers)&&(E.pushLight(O),O.castShadow&&E.pushShadow(O))}),E.setupLights(),H!==null&&H.updateLights(E.state.lightsArray),ct=this.localClippingEnabled,ot=kt.init(this.clippingPlanes,ct),ot===!0&&kt.setGlobalState(this.clippingPlanes,R),H!==null&&Xt.render(E.state.shadowsArray,k,R);let z=new Set;return x.traverse(function(O){if(!(O.isMesh||O.isPoints||O.isLine||O.isSprite))return;let lt=O.material;if(lt)if(Array.isArray(lt))for(let ft=0;ft<lt.length;ft++){let pt=lt[ft];Pi(pt,k,R,O),z.add(pt)}else Pi(lt,k,R,O),z.add(lt)}),E=y.pop(),H!==null&&H.renderEnd(),z},this.compileAsync=function(x,R,k=null){let z=this.compile(x,R,k);return new Promise(O=>{function lt(){if(z.forEach(function(ft){let Tt=G.get(ft).currentProgram;(Tt===void 0||Tt.isReady())&&z.delete(ft)}),z.size===0){O(x);return}setTimeout(lt,10)}Wt.get("KHR_parallel_shader_compile")!==null?lt():setTimeout(lt,10)})};let xs=null;function Uo(x){xs&&xs(x)}function Sr(){In.stop()}function br(){In.start()}let In=new mu;In.setAnimationLoop(Uo),typeof self<"u"&&In.setContext(self),this.setAnimationLoop=function(x){xs=x,Ut.setAnimationLoop(x),x===null?In.stop():In.start()},Ut.addEventListener("sessionstart",Sr),Ut.addEventListener("sessionend",br),this.render=function(x,R){if(R!==void 0&&R.isCamera!==!0){jt("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(F===!0)return;H!==null&&H.renderStart(x,R);let k=Ut.enabled===!0&&Ut.isPresenting===!0,z=T!==null&&(rt===null||k)&&T.begin(C,rt);if(x.matrixWorldAutoUpdate===!0&&x.updateMatrixWorld(),R.parent===null&&R.matrixWorldAutoUpdate===!0&&R.updateMatrixWorld(),Ut.enabled===!0&&Ut.isPresenting===!0&&(T===null||T.isCompositing()===!1)&&(Ut.cameraAutoUpdate===!0&&Ut.updateCamera(R),R=Ut.getCamera()),x.isScene===!0&&x.onBeforeRender(C,x,R,rt),E=Mt.get(x,y.length),E.init(R),E.state.textureUnits=Z.getTextureUnits(),y.push(E),ht.multiplyMatrices(R.projectionMatrix,R.matrixWorldInverse),J.setFromProjectionMatrix(ht,_n,R.reversedDepth),ct=this.localClippingEnabled,ot=kt.init(this.clippingPlanes,ct),b=St.get(x,L.length),b.init(),L.push(b),Ut.enabled===!0&&Ut.isPresenting===!0){let ft=C.xr.getDepthSensingMesh();ft!==null&&ys(ft,R,-1/0,C.sortObjects)}ys(x,R,0,C.sortObjects),b.finish(),H!==null&&H.updateLights(E.state.lightsArray),C.sortObjects===!0&&b.sort(Et,Gt),Zt=Ut.enabled===!1||Ut.isPresenting===!1||Ut.hasDepthSensing()===!1,Zt&&te.addToRenderList(b,x),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),ot===!0&&kt.beginShadows();let O=E.state.shadowsArray;if(Xt.render(O,x,R),ot===!0&&kt.endShadows(),(z&&T.hasRenderPass())===!1){let ft=b.opaque,pt=b.transmissive;if(E.setupLights(),R.isArrayCamera){let Tt=R.cameras;if(pt.length>0)for(let Dt=0,Jt=Tt.length;Dt<Jt;Dt++){let Qt=Tt[Dt];fi(ft,pt,x,Qt)}Zt&&te.render(x);for(let Dt=0,Jt=Tt.length;Dt<Jt;Dt++){let Qt=Tt[Dt];vs(b,x,Qt,Qt.viewport)}}else pt.length>0&&fi(ft,pt,x,R),Zt&&te.render(x),vs(b,x,R)}rt!==null&&q===0&&(Z.updateMultisampleRenderTarget(rt),Z.updateRenderTargetMipmap(rt)),z&&T.end(C),x.isScene===!0&&x.onAfterRender(C,x,R),Ct.resetDefaultState(),Y=-1,nt=null,y.pop(),y.length>0?(E=y[y.length-1],Z.setTextureUnits(E.state.textureUnits),ot===!0&&kt.setGlobalState(C.clippingPlanes,E.state.camera)):E=null,L.pop(),L.length>0?b=L[L.length-1]:b=null,H!==null&&H.renderEnd()};function ys(x,R,k,z){if(x.visible===!1)return;if(x.layers.test(R.layers)){if(x.isGroup)k=x.renderOrder;else if(x.isLOD)x.autoUpdate===!0&&x.update(R);else if(x.isLightProbeGrid)E.pushLightProbeGrid(x);else if(x.isLight)E.pushLight(x),x.castShadow&&E.pushShadow(x);else if(x.isSprite){if(!x.frustumCulled||x.intersectsFrustum(J)){z&&Ht.setFromMatrixPosition(x.matrixWorld).applyMatrix4(ht);let ft=Q.update(x),pt=x.material;pt.visible&&b.push(x,ft,pt,k,Ht.z,null,R)}}else if((x.isMesh||x.isLine||x.isPoints)&&(!x.frustumCulled||x.intersectsFrustum(J))){let ft=Q.update(x),pt=x.material;if(z&&(x.boundingSphere!==void 0?(x.boundingSphere===null&&x.computeBoundingSphere(),Ht.copy(x.boundingSphere.center)):(ft.boundingSphere===null&&ft.computeBoundingSphere(),Ht.copy(ft.boundingSphere.center)),Ht.applyMatrix4(x.matrixWorld).applyMatrix4(ht)),Array.isArray(pt)){let Tt=ft.groups;for(let Dt=0,Jt=Tt.length;Dt<Jt;Dt++){let Qt=Tt[Dt],bt=pt[Qt.materialIndex];bt&&bt.visible&&b.push(x,ft,bt,k,Ht.z,Qt,R)}}else pt.visible&&b.push(x,ft,pt,k,Ht.z,null,R)}}let lt=x.children;for(let ft=0,pt=lt.length;ft<pt;ft++)ys(lt[ft],R,k,z)}function vs(x,R,k,z){let{opaque:O,transmissive:lt,transparent:ft}=x;E.setupLightsView(k),ot===!0&&kt.setGlobalState(C.clippingPlanes,k),z&&g.viewport(st.copy(z)),O.length>0&&Ln(O,R,k),lt.length>0&&Ln(lt,R,k),ft.length>0&&Ln(ft,R,k),g.buffers.depth.setTest(!0),g.buffers.depth.setMask(!0),g.buffers.color.setMask(!0),g.setPolygonOffset(!1)}function fi(x,R,k,z){if((k.isScene===!0?k.overrideMaterial:null)!==null)return;if(E.state.transmissionRenderTarget[z.id]===void 0){let bt=Wt.has("EXT_color_buffer_half_float")||Wt.has("EXT_color_buffer_float");E.state.transmissionRenderTarget[z.id]=new Je(1,1,{generateMipmaps:!0,type:bt?Sn:$e,minFilter:ci,samples:Math.max(4,S.samples),stencilBuffer:r,resolveDepthBuffer:!1,resolveStencilBuffer:!1,storeMultisampledDepthBuffer:!1,storeMultisampledStencilBuffer:!1,colorSpace:ae.workingColorSpace})}let lt=E.state.transmissionRenderTarget[z.id],ft=z.viewport||st;lt.setSize(ft.z*C.transmissionResolutionScale,ft.w*C.transmissionResolutionScale);let pt=C.getRenderTarget(),Tt=C.getActiveCubeFace(),Dt=C.getActiveMipmapLevel();C.setRenderTarget(lt),C.getClearColor(le),Bt=C.getClearAlpha(),Bt<1&&C.setClearColor(16777215,.5),C.clear(),Zt&&te.render(k);let Jt=C.toneMapping;C.toneMapping=vn;let Qt=z.viewport;if(z.viewport!==void 0&&(z.viewport=void 0),E.setupLightsView(z),ot===!0&&kt.setGlobalState(C.clippingPlanes,z),Ln(x,k,z),Z.updateMultisampleRenderTarget(lt),Z.updateRenderTargetMipmap(lt),Wt.has("WEBGL_multisampled_render_to_texture")===!1){let bt=!1;for(let oe=0,Ee=R.length;oe<Ee;oe++){let xe=R[oe],{object:ge,geometry:Ue,material:Nt,group:Ve}=xe;if(Nt.side===un&&ge.layers.test(z.layers)){let he=Nt.side;Nt.side=Xe,Nt.needsUpdate=!0,pi(ge,k,z,Ue,Nt,Ve),Nt.side=he,Nt.needsUpdate=!0,bt=!0}}bt===!0&&(Z.updateMultisampleRenderTarget(lt),Z.updateRenderTargetMipmap(lt))}C.setRenderTarget(pt,Tt,Dt),C.setClearColor(le,Bt),Qt!==void 0&&(z.viewport=Qt),C.toneMapping=Jt}function Ln(x,R,k){let z=R.isScene===!0?R.overrideMaterial:null;for(let O=0,lt=x.length;O<lt;O++){let ft=x[O],{object:pt,geometry:Tt,group:Dt}=ft,Jt=ft.material;Jt.allowOverride===!0&&z!==null&&(Jt=z),pt.layers.test(k.layers)&&pi(pt,R,k,Tt,Jt,Dt)}}function pi(x,R,k,z,O,lt){H!==null&&O.isNodeMaterial&&H.setObject(x,O),x.onBeforeRender(C,R,k,z,O,lt),x.modelViewMatrix.multiplyMatrices(k.matrixWorldInverse,x.matrixWorld),x.normalMatrix.getNormalMatrix(x.modelViewMatrix),O.onBeforeRender(C,R,k,z,x,lt),O.transparent===!0&&O.side===un&&O.forceSinglePass===!1?(O.side=Xe,O.needsUpdate=!0,C.renderBufferDirect(k,R,z,O,x,lt),O.side=oi,O.needsUpdate=!0,C.renderBufferDirect(k,R,z,O,x,lt),O.side=un):C.renderBufferDirect(k,R,z,O,x,lt),x.onAfterRender(C,R,k,z,O,lt)}function mi(x,R,k){R.isScene!==!0&&(R=Vt);let z=G.get(x),O=E.state.lights,lt=E.state.shadowsArray,ft=O.state.version,pt=gt.getParameters(x,O.state,lt,R,k,E.state.lightProbeGridArray),Tt=gt.getProgramCacheKey(pt),Dt=z.programs;z.environment=x.isMeshStandardMaterial||x.isMeshLambertMaterial||x.isMeshPhongMaterial?R.environment:null,z.fog=R.fog;let Jt=x.isMeshStandardMaterial||x.isMeshLambertMaterial&&!x.envMap||x.isMeshPhongMaterial&&!x.envMap;z.envMap=dt.get(x.envMap||z.environment,Jt),z.envMapRotation=z.environment!==null&&x.envMap===null?R.environmentRotation:x.envMapRotation,Dt===void 0&&(x.addEventListener("dispose",ke),Dt=new Map,z.programs=Dt);let Qt=Dt.get(Tt);if(Qt!==void 0){if(z.currentProgram===Qt&&z.lightsStateVersion===ft)return gi(x,pt),Qt}else pt.uniforms=gt.getUniforms(x),H!==null&&x.isNodeMaterial&&H.build(x,k,pt),x.onBeforeCompile(pt,C),Qt=gt.acquireProgram(pt,Tt),Dt.set(Tt,Qt),z.uniforms=pt.uniforms;let bt=z.uniforms;return(!x.isShaderMaterial&&!x.isRawShaderMaterial||x.clipping===!0)&&(bt.clippingPlanes=kt.uniform),gi(x,pt),z.needsLights=vt(x),z.lightsStateVersion=ft,z.needsLights&&(bt.ambientLightColor.value=O.state.ambient,bt.lightProbe.value=O.state.probe,bt.sunLights.value=O.state.sun,bt.sunLightShadows.value=O.state.sunShadow,bt.directionalLights.value=O.state.directional,bt.directionalLightShadows.value=O.state.directionalShadow,bt.spotLights.value=O.state.spot,bt.spotLightShadows.value=O.state.spotShadow,bt.rectAreaLights.value=O.state.rectArea,bt.ltc_1.value=O.state.rectAreaLTC1,bt.ltc_2.value=O.state.rectAreaLTC2,bt.pointLights.value=O.state.point,bt.pointLightShadows.value=O.state.pointShadow,bt.hemisphereLights.value=O.state.hemi,bt.sunShadowMatrix.value=O.state.sunShadowMatrix,bt.sunShadowCascade.value=O.state.sunShadowCascade,bt.directionalShadowMatrix.value=O.state.directionalShadowMatrix,bt.spotLightMatrix.value=O.state.spotLightMatrix,bt.spotLightMap.value=O.state.spotLightMap,bt.pointShadowMatrix.value=O.state.pointShadowMatrix),z.lightProbeGrid=E.state.lightProbeGridArray.length>0,z.currentProgram=Qt,z.uniformsList=null,Qt}function qe(x){if(x.uniformsList===null){let R=x.currentProgram.getUniforms();x.uniformsList=ms.seqWithValue(R.seq,x.uniforms)}return x.uniformsList}function gi(x,R){let k=G.get(x);k.outputColorSpace=R.outputColorSpace,k.batching=R.batching,k.batchingColor=R.batchingColor,k.instancing=R.instancing,k.instancingColor=R.instancingColor,k.instancingMorph=R.instancingMorph,k.skinning=R.skinning,k.morphTargets=R.morphTargets,k.morphNormals=R.morphNormals,k.morphColors=R.morphColors,k.morphTargetsCount=R.morphTargetsCount,k.numClippingPlanes=R.numClippingPlanes,k.numIntersection=R.numClipIntersection,k.vertexAlphas=R.vertexAlphas,k.vertexTangents=R.vertexTangents,k.toneMapping=R.toneMapping}function D(x,R){if(x.length===0)return null;if(x.length===1)return x[0].texture!==null?x[0]:null;v.setFromMatrixPosition(R.matrixWorld);for(let k=0,z=x.length;k<z;k++){let O=x[k];if(O.texture!==null&&O.boundingBox.containsPoint(v))return O}return null}function j(x,R,k,z,O){R.isScene!==!0&&(R=Vt),Z.resetTextureUnits();let lt=R.fog,ft=z.isMeshStandardMaterial||z.isMeshLambertMaterial||z.isMeshPhongMaterial?R.environment:null,pt=rt===null?C.outputColorSpace:rt.isXRRenderTarget===!0?rt.texture.colorSpace:ae.workingColorSpace,Tt=z.isMeshStandardMaterial||z.isMeshLambertMaterial&&!z.envMap||z.isMeshPhongMaterial&&!z.envMap,Dt=dt.get(z.envMap||ft,Tt),Jt=z.vertexColors===!0&&!!k.attributes.color&&k.attributes.color.itemSize===4,Qt=!!k.attributes.tangent&&(!!z.normalMap||z.anisotropy>0),bt=!!k.morphAttributes.position,oe=!!k.morphAttributes.normal,Ee=!!k.morphAttributes.color,xe=vn;z.toneMapped&&(rt===null||rt.isXRRenderTarget===!0)&&(xe=C.toneMapping);let ge=k.morphAttributes.position||k.morphAttributes.normal||k.morphAttributes.color,Ue=ge!==void 0?ge.length:0,Nt=G.get(z),Ve=E.state.lights;if(ot===!0&&(ct===!0||x!==nt)){let _e=x===nt&&z.id===Y;kt.setState(z,x,_e)}let he=!1;z.version===Nt.__version?(Nt.needsLights&&Nt.lightsStateVersion!==Ve.state.version||Nt.outputColorSpace!==pt||O.isBatchedMesh&&Nt.batching===!1||!O.isBatchedMesh&&Nt.batching===!0||O.isBatchedMesh&&Nt.batchingColor===!0&&O._colorsTexture===null||O.isBatchedMesh&&Nt.batchingColor===!1&&O._colorsTexture!==null||O.isInstancedMesh&&Nt.instancing===!1||!O.isInstancedMesh&&Nt.instancing===!0||O.isSkinnedMesh&&Nt.skinning===!1||!O.isSkinnedMesh&&Nt.skinning===!0||O.isInstancedMesh&&Nt.instancingColor===!0&&O.instanceColor===null||O.isInstancedMesh&&Nt.instancingColor===!1&&O.instanceColor!==null||O.isInstancedMesh&&Nt.instancingMorph===!0&&O.morphTexture===null||O.isInstancedMesh&&Nt.instancingMorph===!1&&O.morphTexture!==null||Nt.envMap!==Dt||z.fog===!0&&Nt.fog!==lt||Nt.numClippingPlanes!==void 0&&(Nt.numClippingPlanes!==kt.numPlanes||Nt.numIntersection!==kt.numIntersection)||Nt.vertexAlphas!==Jt||Nt.vertexTangents!==Qt||Nt.morphTargets!==bt||Nt.morphNormals!==oe||Nt.morphColors!==Ee||Nt.toneMapping!==xe||Nt.morphTargetsCount!==Ue||!!Nt.lightProbeGrid!=E.state.lightProbeGridArray.length>0)&&(he=!0):(he=!0,Nt.__version=z.version);let on=Nt.currentProgram;he===!0&&(on=mi(z,R,O),H&&z.isNodeMaterial&&H.onUpdateProgram(z,on,Nt));let bn=!1,Wn=!1,Ii=!1,me=on.getUniforms(),Se=Nt.uniforms;if(g.useProgram(on.program)&&(bn=!0,Wn=!0,Ii=!0),z.id!==Y&&(Y=z.id,Wn=!0),Nt.needsLights){let _e=D(E.state.lightProbeGridArray,O);Nt.lightProbeGrid!==_e&&(Nt.lightProbeGrid=_e,Wn=!0)}if(bn||nt!==x){g.buffers.depth.getReversed()&&x.reversedDepth!==!0&&(x._reversedDepth=!0,x.updateProjectionMatrix()),me.setValue(P,"projectionMatrix",x.projectionMatrix),me.setValue(P,"viewMatrix",x.matrixWorldInverse);let qn=me.map.cameraPosition;qn!==void 0&&qn.setValue(P,mt.setFromMatrixPosition(x.matrixWorld)),S.logarithmicDepthBuffer&&me.setValue(P,"logDepthBufFC",2/(Math.log(x.far+1)/Math.LN2)),(z.isMeshPhongMaterial||z.isMeshToonMaterial||z.isMeshLambertMaterial||z.isMeshBasicMaterial||z.isMeshStandardMaterial||z.isShaderMaterial)&&me.setValue(P,"isOrthographic",x.isOrthographicCamera===!0),nt!==x&&(nt=x,Wn=!0,Ii=!0)}if(Nt.needsLights&&(Ve.state.sunShadowMap.length>0&&me.setValue(P,"sunShadowMap",Ve.state.sunShadowMap,Z),Ve.state.directionalShadowMap.length>0&&me.setValue(P,"directionalShadowMap",Ve.state.directionalShadowMap,Z),Ve.state.spotShadowMap.length>0&&me.setValue(P,"spotShadowMap",Ve.state.spotShadowMap,Z),Ve.state.pointShadowMap.length>0&&me.setValue(P,"pointShadowMap",Ve.state.pointShadowMap,Z)),O.isSkinnedMesh){me.setOptional(P,O,"bindMatrix"),me.setOptional(P,O,"bindMatrixInverse");let _e=O.skeleton;_e&&(_e.boneTexture===null&&_e.computeBoneTexture(),me.setValue(P,"boneTexture",_e.boneTexture,Z))}O.isBatchedMesh&&(me.setOptional(P,O,"batchingTexture"),me.setValue(P,"batchingTexture",O._matricesTexture,Z),me.setOptional(P,O,"batchingIdTexture"),me.setValue(P,"batchingIdTexture",O._indirectTexture,Z),me.setOptional(P,O,"batchingColorTexture"),O._colorsTexture!==null&&me.setValue(P,"batchingColorTexture",O._colorsTexture,Z));let Xn=k.morphAttributes;if((Xn.position!==void 0||Xn.normal!==void 0||Xn.color!==void 0)&&N.update(O,k,on),(Wn||Nt.receiveShadow!==O.receiveShadow)&&(Nt.receiveShadow=O.receiveShadow,me.setValue(P,"receiveShadow",O.receiveShadow)),(z.isMeshStandardMaterial||z.isMeshLambertMaterial||z.isMeshPhongMaterial)&&z.envMap===null&&R.environment!==null&&(Se.envMapIntensity.value=R.environmentIntensity),Se.dfgLUT!==void 0&&(Se.dfgLUT.value=j_()),Wn){if(me.setValue(P,"toneMappingExposure",C.toneMappingExposure),Nt.needsLights&&at(Se,Ii),lt&&z.fog===!0&&Ft.refreshFogUniforms(Se,lt),Ft.refreshMaterialUniforms(Se,z,it,X,E.state.transmissionRenderTarget[x.id]),Nt.needsLights&&Nt.lightProbeGrid){let _e=Nt.lightProbeGrid;Se.probesSH.value=_e.texture,Se.probesMin.value.copy(_e.boundingBox.min),Se.probesMax.value.copy(_e.boundingBox.max),Se.probesResolution.value.copy(_e.resolution)}ms.upload(P,qe(Nt),Se,Z)}if(z.isShaderMaterial&&z.uniformsNeedUpdate===!0&&(ms.upload(P,qe(Nt),Se,Z),z.uniformsNeedUpdate=!1),z.isSpriteMaterial&&me.setValue(P,"center",O.center),me.setValue(P,"modelViewMatrix",O.modelViewMatrix),me.setValue(P,"normalMatrix",O.normalMatrix),me.setValue(P,"modelMatrix",O.matrixWorld),z.uniformsGroups!==void 0){let _e=z.uniformsGroups;for(let qn=0,Li=_e.length;qn<Li;qn++){let xc=_e[qn];et.update(xc,on),et.bind(xc,on)}}return on}function at(x,R){x.ambientLightColor.needsUpdate=R,x.lightProbe.needsUpdate=R,x.sunLights.needsUpdate=R,x.sunLightShadows.needsUpdate=R,x.directionalLights.needsUpdate=R,x.directionalLightShadows.needsUpdate=R,x.pointLights.needsUpdate=R,x.pointLightShadows.needsUpdate=R,x.spotLights.needsUpdate=R,x.spotLightShadows.needsUpdate=R,x.rectAreaLights.needsUpdate=R,x.hemisphereLights.needsUpdate=R}function vt(x){return x.isMeshLambertMaterial||x.isMeshToonMaterial||x.isMeshPhongMaterial||x.isMeshStandardMaterial||x.isShadowMaterial||x.isShaderMaterial&&x.lights===!0}this.getActiveCubeFace=function(){return K},this.getActiveMipmapLevel=function(){return q},this.getRenderTarget=function(){return rt},this.setRenderTargetTextures=function(x,R,k){let z=G.get(x);z.__autoAllocateDepthBuffer=x.resolveDepthBuffer===!1,z.__autoAllocateDepthBuffer===!1&&(z.__useRenderToTexture=!1),G.get(x.texture).__webglTexture=R,G.get(x.depthTexture).__webglTexture=z.__autoAllocateDepthBuffer?void 0:k,z.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(x,R){let k=G.get(x);k.__webglFramebuffer=R,k.__useDefaultFramebuffer=R===void 0},this.setRenderTarget=function(x,R=0,k=0){rt=x,K=R,q=k;let z=null,O=!1,lt=!1;if(x){let pt=G.get(x);if(pt.__useDefaultFramebuffer!==void 0){g.bindFramebuffer(P.FRAMEBUFFER,pt.__webglFramebuffer),st.copy(x.viewport),Ot.copy(x.scissor),Lt=x.scissorTest,g.viewport(st),g.scissor(Ot),g.setScissorTest(Lt),Y=-1;return}else if(pt.__webglFramebuffer===void 0)Z.setupRenderTarget(x);else if(pt.__hasExternalTextures)Z.rebindTextures(x,G.get(x.texture).__webglTexture,G.get(x.depthTexture).__webglTexture);else if(x.depthBuffer){let Jt=x.depthTexture;if(pt.__boundDepthTexture!==Jt){if(Jt!==null&&G.has(Jt)&&(x.width!==Jt.image.width||x.height!==Jt.image.height))throw new Error("THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.");Z.setupDepthRenderbuffer(x)}}let Tt=x.texture;(Tt.isData3DTexture||Tt.isDataArrayTexture||Tt.isCompressedArrayTexture)&&(lt=!0);let Dt=G.get(x).__webglFramebuffer;x.isWebGLCubeRenderTarget?(Array.isArray(Dt[R])?z=Dt[R][k]:z=Dt[R],O=!0):x.samples>0&&Z.useMultisampledRTT(x)===!1?z=G.get(x).__webglMultisampledFramebuffer:Array.isArray(Dt)?z=Dt[k]:z=Dt,st.copy(x.viewport),Ot.copy(x.scissor),Lt=x.scissorTest}else st.copy(At).multiplyScalar(it).floor(),Ot.copy(Yt).multiplyScalar(it).floor(),Lt=It;if(k!==0&&(z=W),g.bindFramebuffer(P.FRAMEBUFFER,z)&&g.drawBuffers(x,z),g.viewport(st),g.scissor(Ot),g.setScissorTest(Lt),O){let pt=G.get(x.texture);P.framebufferTexture2D(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_CUBE_MAP_POSITIVE_X+R,pt.__webglTexture,k)}else if(lt){let pt=R;for(let Tt=0;Tt<x.textures.length;Tt++){let Dt=G.get(x.textures[Tt]);P.framebufferTextureLayer(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0+Tt,Dt.__webglTexture,k,pt)}}else if(x!==null&&k!==0){let pt=G.get(x.texture);P.framebufferTexture2D(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,pt.__webglTexture,k)}Y=-1};function Rt(x){let R=G.get(x);return(R.__readFormat!==x.format||R.__readType!==x.type)&&(R.__readFormat=x.format,R.__readType=x.type,R.__formatReadable=S.textureFormatReadable(x.format),R.__typeReadable=S.textureTypeReadable(x.type)),R}this.readRenderTargetPixels=function(x,R,k,z,O,lt,ft,pt=0){if(!(x&&x.isWebGLRenderTarget)){jt("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Tt=G.get(x).__webglFramebuffer;if(x.isWebGLCubeRenderTarget&&ft!==void 0&&(Tt=Tt[ft]),Tt){g.bindFramebuffer(P.FRAMEBUFFER,Tt);try{let Dt=x.textures[pt],Jt=Dt.format,Qt=Dt.type;x.textures.length>1&&P.readBuffer(P.COLOR_ATTACHMENT0+pt);let bt=Rt(Dt);if(bt.__formatReadable===!1){jt("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(bt.__typeReadable===!1){jt("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}R>=0&&R<=x.width-z&&k>=0&&k<=x.height-O&&P.readPixels(R,k,z,O,yt.convert(Jt),yt.convert(Qt),lt)}finally{let Dt=rt!==null?G.get(rt).__webglFramebuffer:null;g.bindFramebuffer(P.FRAMEBUFFER,Dt)}}},this.readRenderTargetPixelsAsync=async function(x,R,k,z,O,lt,ft,pt=0){if(!(x&&x.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Tt=G.get(x).__webglFramebuffer;if(x.isWebGLCubeRenderTarget&&ft!==void 0&&(Tt=Tt[ft]),Tt)if(R>=0&&R<=x.width-z&&k>=0&&k<=x.height-O){g.bindFramebuffer(P.FRAMEBUFFER,Tt);let Dt=x.textures[pt],Jt=Dt.format,Qt=Dt.type;x.textures.length>1&&P.readBuffer(P.COLOR_ATTACHMENT0+pt);let bt=Rt(Dt);if(bt.__formatReadable===!1)throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(bt.__typeReadable===!1)throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");let oe=P.createBuffer();P.bindBuffer(P.PIXEL_PACK_BUFFER,oe),P.bufferData(P.PIXEL_PACK_BUFFER,lt.byteLength,P.STREAM_READ),P.readPixels(R,k,z,O,yt.convert(Jt),yt.convert(Qt),0),P.bindBuffer(P.PIXEL_PACK_BUFFER,null);let Ee=rt!==null?G.get(rt).__webglFramebuffer:null;g.bindFramebuffer(P.FRAMEBUFFER,Ee);let xe=P.fenceSync(P.SYNC_GPU_COMMANDS_COMPLETE,0);return P.flush(),await Bh(P,xe,4),P.bindBuffer(P.PIXEL_PACK_BUFFER,oe),P.getBufferSubData(P.PIXEL_PACK_BUFFER,0,lt),P.bindBuffer(P.PIXEL_PACK_BUFFER,null),P.deleteBuffer(oe),P.deleteSync(xe),lt}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(x,R=null,k=0){let z=Math.pow(2,-k),O=Math.floor(x.image.width*z),lt=Math.floor(x.image.height*z),ft=R!==null?R.x:0,pt=R!==null?R.y:0;Z.setTexture2D(x,0),P.copyTexSubImage2D(P.TEXTURE_2D,k,0,0,ft,pt,O,lt),g.unbindTexture()},this.copyTextureToTexture=function(x,R,k=null,z=null,O=0,lt=0){let ft,pt,Tt,Dt,Jt,Qt,bt,oe,Ee,xe=x.isCompressedTexture?x.mipmaps[lt]:x.image;if(k!==null)ft=k.max.x-k.min.x,pt=k.max.y-k.min.y,Tt=k.isBox3?k.max.z-k.min.z:1,Dt=k.min.x,Jt=k.min.y,Qt=k.isBox3?k.min.z:0;else{let Se=Math.pow(2,-O);ft=Math.floor(xe.width*Se),pt=Math.floor(xe.height*Se),x.isDataArrayTexture?Tt=xe.depth:x.isData3DTexture?Tt=Math.floor(xe.depth*Se):Tt=1,Dt=0,Jt=0,Qt=0}z!==null?(bt=z.x,oe=z.y,Ee=z.z):(bt=0,oe=0,Ee=0);let ge=yt.convert(R.format),Ue=yt.convert(R.type),Nt;R.isData3DTexture?(Z.setTexture3D(R,0),Nt=P.TEXTURE_3D):R.isDataArrayTexture||R.isCompressedArrayTexture?(Z.setTexture2DArray(R,0),Nt=P.TEXTURE_2D_ARRAY):(Z.setTexture2D(R,0),Nt=P.TEXTURE_2D),g.activeTexture(P.TEXTURE0),g.pixelStorei(P.UNPACK_FLIP_Y_WEBGL,R.flipY),g.pixelStorei(P.UNPACK_PREMULTIPLY_ALPHA_WEBGL,R.premultiplyAlpha),g.pixelStorei(P.UNPACK_ALIGNMENT,R.unpackAlignment);let Ve=g.getParameter(P.UNPACK_ROW_LENGTH),he=g.getParameter(P.UNPACK_IMAGE_HEIGHT),on=g.getParameter(P.UNPACK_SKIP_PIXELS),bn=g.getParameter(P.UNPACK_SKIP_ROWS),Wn=g.getParameter(P.UNPACK_SKIP_IMAGES);g.pixelStorei(P.UNPACK_ROW_LENGTH,xe.width),g.pixelStorei(P.UNPACK_IMAGE_HEIGHT,xe.height),g.pixelStorei(P.UNPACK_SKIP_PIXELS,Dt),g.pixelStorei(P.UNPACK_SKIP_ROWS,Jt),g.pixelStorei(P.UNPACK_SKIP_IMAGES,Qt);let Ii=x.isDataArrayTexture||x.isData3DTexture,me=R.isDataArrayTexture||R.isData3DTexture;if(x.isDepthTexture){let Se=G.get(x),Xn=G.get(R),_e=G.get(Se.__renderTarget),qn=G.get(Xn.__renderTarget);g.bindFramebuffer(P.READ_FRAMEBUFFER,_e.__webglFramebuffer),g.bindFramebuffer(P.DRAW_FRAMEBUFFER,qn.__webglFramebuffer);for(let Li=0;Li<Tt;Li++)Ii&&(P.framebufferTextureLayer(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,G.get(x).__webglTexture,O,Qt+Li),P.framebufferTextureLayer(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,G.get(R).__webglTexture,lt,Ee+Li)),P.blitFramebuffer(Dt,Jt,ft,pt,bt,oe,ft,pt,P.DEPTH_BUFFER_BIT,P.NEAREST);g.bindFramebuffer(P.READ_FRAMEBUFFER,null),g.bindFramebuffer(P.DRAW_FRAMEBUFFER,null)}else if(O!==0||x.isRenderTargetTexture||G.has(x)){let Se=G.get(x),Xn=G.get(R);g.bindFramebuffer(P.READ_FRAMEBUFFER,U),g.bindFramebuffer(P.DRAW_FRAMEBUFFER,V);for(let _e=0;_e<Tt;_e++)Ii?P.framebufferTextureLayer(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,Se.__webglTexture,O,Qt+_e):P.framebufferTexture2D(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,Se.__webglTexture,O),me?P.framebufferTextureLayer(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,Xn.__webglTexture,lt,Ee+_e):P.framebufferTexture2D(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,Xn.__webglTexture,lt),O!==0?P.blitFramebuffer(Dt,Jt,ft,pt,bt,oe,ft,pt,P.COLOR_BUFFER_BIT,P.NEAREST):me?P.copyTexSubImage3D(Nt,lt,bt,oe,Ee+_e,Dt,Jt,ft,pt):P.copyTexSubImage2D(Nt,lt,bt,oe,Dt,Jt,ft,pt);g.bindFramebuffer(P.READ_FRAMEBUFFER,null),g.bindFramebuffer(P.DRAW_FRAMEBUFFER,null)}else me?x.isDataTexture||x.isData3DTexture?P.texSubImage3D(Nt,lt,bt,oe,Ee,ft,pt,Tt,ge,Ue,xe.data):R.isCompressedArrayTexture?P.compressedTexSubImage3D(Nt,lt,bt,oe,Ee,ft,pt,Tt,ge,xe.data):P.texSubImage3D(Nt,lt,bt,oe,Ee,ft,pt,Tt,ge,Ue,xe):x.isDataTexture?P.texSubImage2D(P.TEXTURE_2D,lt,bt,oe,ft,pt,ge,Ue,xe.data):x.isCompressedTexture?P.compressedTexSubImage2D(P.TEXTURE_2D,lt,bt,oe,xe.width,xe.height,ge,xe.data):P.texSubImage2D(P.TEXTURE_2D,lt,bt,oe,ft,pt,ge,Ue,xe);g.pixelStorei(P.UNPACK_ROW_LENGTH,Ve),g.pixelStorei(P.UNPACK_IMAGE_HEIGHT,he),g.pixelStorei(P.UNPACK_SKIP_PIXELS,on),g.pixelStorei(P.UNPACK_SKIP_ROWS,bn),g.pixelStorei(P.UNPACK_SKIP_IMAGES,Wn),lt===0&&R.generateMipmaps&&P.generateMipmap(Nt),g.unbindTexture()},this.initRenderTarget=function(x){G.get(x).__webglFramebuffer===void 0&&Z.setupRenderTarget(x)},this.initTexture=function(x){x.isCubeTexture?Z.setTextureCube(x,0):x.isData3DTexture?Z.setTexture3D(x,0):x.isDataArrayTexture||x.isCompressedArrayTexture?Z.setTexture2DArray(x,0):Z.setTexture2D(x,0),g.unbindTexture()},this.resetState=function(){K=0,q=0,rt=null,g.reset(),Ct.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return _n}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;let e=this.getContext();e.drawingBufferColorSpace=ae._getDrawingBufferColorSpace(t),e.unpackColorSpace=ae._getUnpackColorSpace()}};var Su={type:"change"},dc={type:"start"},Eu={type:"end"},Lo=new Qn,bu=new tn,t0=Math.cos(70*Wl.DEG2RAD),Ie=new I,Ke=2*Math.PI,pe={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6},uc=1e-6,Do=class extends cr{constructor(t,e=null){super(t,e),this.state=pe.NONE,this.target=new I,this.cursor=new I,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.keyRotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:"ArrowLeft",UP:"ArrowUp",RIGHT:"ArrowRight",BOTTOM:"ArrowDown"},this.mouseButtons={LEFT:yn.ROTATE,MIDDLE:yn.DOLLY,RIGHT:yn.PAN},this.touches={ONE:ai.ROTATE,TWO:ai.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._cursorStyle="auto",this._domElementKeyEvents=null,this._lastPosition=new I,this._lastQuaternion=new nn,this._lastTargetPosition=new I,this._quat=new nn().setFromUnitVectors(t.up,new I(0,1,0)),this._quatInverse=this._quat.clone().invert(),this._spherical=new ls,this._sphericalDelta=new ls,this._scale=1,this._panOffset=new I,this._rotateStart=new ut,this._rotateEnd=new ut,this._rotateDelta=new ut,this._panStart=new ut,this._panEnd=new ut,this._panDelta=new ut,this._dollyStart=new ut,this._dollyEnd=new ut,this._dollyDelta=new ut,this._dollyDirection=new I,this._mouse=new ut,this._performCursorZoom=!1,this._pointers=[],this._pointerPositions={},this._controlActive=!1,this._onPointerMove=n0.bind(this),this._onPointerDown=e0.bind(this),this._onPointerUp=i0.bind(this),this._onContextMenu=h0.bind(this),this._onMouseWheel=a0.bind(this),this._onKeyDown=o0.bind(this),this._onTouchStart=l0.bind(this),this._onTouchMove=c0.bind(this),this._onMouseDown=s0.bind(this),this._onMouseMove=r0.bind(this),this._interceptControlDown=u0.bind(this),this._interceptControlUp=d0.bind(this),this.domElement!==null&&this.connect(this.domElement),this.update()}set cursorStyle(t){this._cursorStyle=t,t==="grab"?this.domElement.style.cursor="grab":this.domElement.style.cursor="auto"}get cursorStyle(){return this._cursorStyle}connect(t){super.connect(t),this.domElement.addEventListener("pointerdown",this._onPointerDown),this.domElement.addEventListener("pointercancel",this._onPointerUp),this.domElement.addEventListener("contextmenu",this._onContextMenu),this.domElement.addEventListener("wheel",this._onMouseWheel,{passive:!1}),this.domElement.getRootNode().addEventListener("keydown",this._interceptControlDown,{passive:!0,capture:!0}),this.domElement.style.touchAction="none"}disconnect(){this.state=pe.NONE,this.domElement.removeEventListener("pointerdown",this._onPointerDown),this.domElement.ownerDocument.removeEventListener("pointermove",this._onPointerMove),this.domElement.ownerDocument.removeEventListener("pointerup",this._onPointerUp),this.domElement.removeEventListener("pointercancel",this._onPointerUp),this.domElement.removeEventListener("wheel",this._onMouseWheel),this.domElement.removeEventListener("contextmenu",this._onContextMenu),this.stopListenToKeyEvents();let t=this.domElement.getRootNode();t.removeEventListener("keydown",this._interceptControlDown,{capture:!0}),t.removeEventListener("keyup",this._interceptControlUp,{capture:!0}),this._controlActive=!1,this._pointers.length=0,this._pointerPositions={},this.domElement.style.touchAction="",this.domElement.style.cursor="auto"}dispose(){this.disconnect()}getPolarAngle(){return this._spherical.phi}getAzimuthalAngle(){return this._spherical.theta}getDistance(){return this.object.position.distanceTo(this.target)}listenToKeyEvents(t){t.addEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=t}stopListenToKeyEvents(){this._domElementKeyEvents!==null&&(this._domElementKeyEvents.removeEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=null)}saveState(){this.target0.copy(this.target),this.position0.copy(this.object.position),this.zoom0=this.object.zoom}reset(){this.target.copy(this.target0),this.object.position.copy(this.position0),this.object.zoom=this.zoom0,this.object.updateProjectionMatrix(),this.dispatchEvent(Su),this.update(),this.state=pe.NONE}pan(t,e){this._pan(t,e),this.update()}dollyIn(t){this._dollyIn(t),this.update()}dollyOut(t){this._dollyOut(t),this.update()}rotateLeft(t){this._rotateLeft(t),this.update()}rotateUp(t){this._rotateUp(t),this.update()}update(t=null){let e=this.object.position;Ie.copy(e).sub(this.target),Ie.applyQuaternion(this._quat),this._spherical.setFromVector3(Ie),this.autoRotate&&this.state===pe.NONE&&this._rotateLeft(this._getAutoRotationAngle(t)),this.enableDamping?(this._spherical.theta+=this._sphericalDelta.theta*this.dampingFactor,this._spherical.phi+=this._sphericalDelta.phi*this.dampingFactor):(this._spherical.theta+=this._sphericalDelta.theta,this._spherical.phi+=this._sphericalDelta.phi);let n=this.minAzimuthAngle,s=this.maxAzimuthAngle;isFinite(n)&&isFinite(s)&&(n<-Math.PI?n+=Ke:n>Math.PI&&(n-=Ke),s<-Math.PI?s+=Ke:s>Math.PI&&(s-=Ke),n<=s?this._spherical.theta=Math.max(n,Math.min(s,this._spherical.theta)):this._spherical.theta=this._spherical.theta>(n+s)/2?Math.max(n,this._spherical.theta):Math.min(s,this._spherical.theta)),this._spherical.phi=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,this._spherical.phi)),this._spherical.makeSafe(),this.enableDamping===!0?this.target.addScaledVector(this._panOffset,this.dampingFactor):this.target.add(this._panOffset),this.target.sub(this.cursor),this.target.clampLength(this.minTargetRadius,this.maxTargetRadius),this.target.add(this.cursor);let r=!1;if(this.zoomToCursor&&this._performCursorZoom||this.object.isOrthographicCamera)this._spherical.radius=this._clampDistance(this._spherical.radius);else{let a=this._spherical.radius;this._spherical.radius=this._clampDistance(this._spherical.radius*this._scale),r=a!=this._spherical.radius}if(Ie.setFromSpherical(this._spherical),Ie.applyQuaternion(this._quatInverse),e.copy(this.target).add(Ie),this.object.lookAt(this.target),this.enableDamping===!0?(this._sphericalDelta.theta*=1-this.dampingFactor,this._sphericalDelta.phi*=1-this.dampingFactor,this._panOffset.multiplyScalar(1-this.dampingFactor)):(this._sphericalDelta.set(0,0,0),this._panOffset.set(0,0,0)),this.zoomToCursor&&this._performCursorZoom){let a=null;if(this.object.isPerspectiveCamera){let o=Ie.length();a=this._clampDistance(o*this._scale);let l=o-a;this.object.position.addScaledVector(this._dollyDirection,l),this.object.updateMatrixWorld(),r=!!l}else if(this.object.isOrthographicCamera){let o=new I(this._mouse.x,this._mouse.y,0);o.unproject(this.object);let l=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),this.object.updateProjectionMatrix(),r=l!==this.object.zoom;let c=new I(this._mouse.x,this._mouse.y,0);c.unproject(this.object),this.object.position.sub(c).add(o),this.object.updateMatrixWorld(),a=Ie.length()}else console.warn("WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled."),this.zoomToCursor=!1;a!==null&&(this.screenSpacePanning?this.target.set(0,0,-1).transformDirection(this.object.matrix).multiplyScalar(a).add(this.object.position):(Lo.origin.copy(this.object.position),Lo.direction.set(0,0,-1).transformDirection(this.object.matrix),Math.abs(this.object.up.dot(Lo.direction))<t0?this.object.lookAt(this.target):(bu.setFromNormalAndCoplanarPoint(this.object.up,this.target),Lo.intersectPlane(bu,this.target))))}else if(this.object.isOrthographicCamera){let a=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),a!==this.object.zoom&&(this.object.updateProjectionMatrix(),r=!0)}return this._scale=1,this._performCursorZoom=!1,r||this._lastPosition.distanceToSquared(this.object.position)>uc||8*(1-this._lastQuaternion.dot(this.object.quaternion))>uc||this._lastTargetPosition.distanceToSquared(this.target)>uc?(this.dispatchEvent(Su),this._lastPosition.copy(this.object.position),this._lastQuaternion.copy(this.object.quaternion),this._lastTargetPosition.copy(this.target),!0):!1}_getAutoRotationAngle(t){return t!==null?Ke/60*this.autoRotateSpeed*t:Ke/60/60*this.autoRotateSpeed}_getZoomScale(t){let e=Math.abs(t*.01);return Math.pow(.95,this.zoomSpeed*e)}_rotateLeft(t){this._sphericalDelta.theta-=t}_rotateUp(t){this._sphericalDelta.phi-=t}_panLeft(t,e){Ie.setFromMatrixColumn(e,0),Ie.multiplyScalar(-t),this._panOffset.add(Ie)}_panUp(t,e){this.screenSpacePanning===!0?Ie.setFromMatrixColumn(e,1):(Ie.setFromMatrixColumn(e,0),Ie.crossVectors(this.object.up,Ie)),Ie.multiplyScalar(t),this._panOffset.add(Ie)}_pan(t,e){let n=this.domElement;if(this.object.isPerspectiveCamera){let s=this.object.position;Ie.copy(s).sub(this.target);let r=Ie.length();r*=Math.tan(this.object.fov/2*Math.PI/180),this._panLeft(2*t*r/n.clientHeight,this.object.matrix),this._panUp(2*e*r/n.clientHeight,this.object.matrix)}else this.object.isOrthographicCamera?(this._panLeft(t*(this.object.right-this.object.left)/this.object.zoom/n.clientWidth,this.object.matrix),this._panUp(e*(this.object.top-this.object.bottom)/this.object.zoom/n.clientHeight,this.object.matrix)):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."),this.enablePan=!1)}_dollyOut(t){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale/=t:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_dollyIn(t){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale*=t:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_updateZoomParameters(t,e){if(!this.zoomToCursor)return;this._performCursorZoom=!0;let n=this.domElement.getBoundingClientRect(),s=t-n.left,r=e-n.top,a=n.width,o=n.height;this._mouse.x=s/a*2-1,this._mouse.y=-(r/o)*2+1,this._dollyDirection.set(this._mouse.x,this._mouse.y,1).unproject(this.object).sub(this.object.position).normalize()}_clampDistance(t){return Math.max(this.minDistance,Math.min(this.maxDistance,t))}_handleMouseDownRotate(t){this._rotateStart.set(t.clientX,t.clientY)}_handleMouseDownDolly(t){this._updateZoomParameters(t.clientX,t.clientX),this._dollyStart.set(t.clientX,t.clientY)}_handleMouseDownPan(t){this._panStart.set(t.clientX,t.clientY)}_handleMouseMoveRotate(t){this._rotateEnd.set(t.clientX,t.clientY),this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);let e=this.domElement;this._rotateLeft(Ke*this._rotateDelta.x/e.clientHeight),this._rotateUp(Ke*this._rotateDelta.y/e.clientHeight),this._rotateStart.copy(this._rotateEnd),this.update()}_handleMouseMoveDolly(t){this._dollyEnd.set(t.clientX,t.clientY),this._dollyDelta.subVectors(this._dollyEnd,this._dollyStart),this._dollyDelta.y>0?this._dollyOut(this._getZoomScale(this._dollyDelta.y)):this._dollyDelta.y<0&&this._dollyIn(this._getZoomScale(this._dollyDelta.y)),this._dollyStart.copy(this._dollyEnd),this.update()}_handleMouseMovePan(t){this._panEnd.set(t.clientX,t.clientY),this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd),this.update()}_handleMouseWheel(t){this._updateZoomParameters(t.clientX,t.clientY),t.deltaY<0?this._dollyIn(this._getZoomScale(t.deltaY)):t.deltaY>0&&this._dollyOut(this._getZoomScale(t.deltaY)),this.update()}_handleKeyDown(t){let e=!1;switch(t.code){case this.keys.UP:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateUp(Ke*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,this.keyPanSpeed),e=!0;break;case this.keys.BOTTOM:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateUp(-Ke*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,-this.keyPanSpeed),e=!0;break;case this.keys.LEFT:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateLeft(Ke*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(this.keyPanSpeed,0),e=!0;break;case this.keys.RIGHT:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateLeft(-Ke*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(-this.keyPanSpeed,0),e=!0;break}e&&(t.preventDefault(),this.update())}_handleTouchStartRotate(t){if(this._pointers.length===1)this._rotateStart.set(t.pageX,t.pageY);else{let e=this._getSecondPointerPosition(t),n=.5*(t.pageX+e.x),s=.5*(t.pageY+e.y);this._rotateStart.set(n,s)}}_handleTouchStartPan(t){if(this._pointers.length===1)this._panStart.set(t.pageX,t.pageY);else{let e=this._getSecondPointerPosition(t),n=.5*(t.pageX+e.x),s=.5*(t.pageY+e.y);this._panStart.set(n,s)}}_handleTouchStartDolly(t){let e=this._getSecondPointerPosition(t),n=t.pageX-e.x,s=t.pageY-e.y,r=Math.sqrt(n*n+s*s);this._dollyStart.set(0,r)}_handleTouchStartDollyPan(t){this.enableZoom&&this._handleTouchStartDolly(t),this.enablePan&&this._handleTouchStartPan(t)}_handleTouchStartDollyRotate(t){this.enableZoom&&this._handleTouchStartDolly(t),this.enableRotate&&this._handleTouchStartRotate(t)}_handleTouchMoveRotate(t){if(this._pointers.length==1)this._rotateEnd.set(t.pageX,t.pageY);else{let n=this._getSecondPointerPosition(t),s=.5*(t.pageX+n.x),r=.5*(t.pageY+n.y);this._rotateEnd.set(s,r)}this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);let e=this.domElement;this._rotateLeft(Ke*this._rotateDelta.x/e.clientHeight),this._rotateUp(Ke*this._rotateDelta.y/e.clientHeight),this._rotateStart.copy(this._rotateEnd)}_handleTouchMovePan(t){if(this._pointers.length===1)this._panEnd.set(t.pageX,t.pageY);else{let e=this._getSecondPointerPosition(t),n=.5*(t.pageX+e.x),s=.5*(t.pageY+e.y);this._panEnd.set(n,s)}this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd)}_handleTouchMoveDolly(t){let e=this._getSecondPointerPosition(t),n=t.pageX-e.x,s=t.pageY-e.y,r=Math.sqrt(n*n+s*s);this._dollyEnd.set(0,r),this._dollyDelta.set(0,Math.pow(this._dollyEnd.y/this._dollyStart.y,this.zoomSpeed)),this._dollyOut(this._dollyDelta.y),this._dollyStart.copy(this._dollyEnd);let a=(t.pageX+e.x)*.5,o=(t.pageY+e.y)*.5;this._updateZoomParameters(a,o)}_handleTouchMoveDollyPan(t){this.enableZoom&&this._handleTouchMoveDolly(t),this.enablePan&&this._handleTouchMovePan(t)}_handleTouchMoveDollyRotate(t){this.enableZoom&&this._handleTouchMoveDolly(t),this.enableRotate&&this._handleTouchMoveRotate(t)}_addPointer(t){this._pointers.push(t.pointerId)}_removePointer(t){delete this._pointerPositions[t.pointerId];for(let e=0;e<this._pointers.length;e++)if(this._pointers[e]==t.pointerId){this._pointers.splice(e,1);return}}_isTrackingPointer(t){for(let e=0;e<this._pointers.length;e++)if(this._pointers[e]==t.pointerId)return!0;return!1}_trackPointer(t){let e=this._pointerPositions[t.pointerId];e===void 0&&(e=new ut,this._pointerPositions[t.pointerId]=e),e.set(t.pageX,t.pageY)}_getSecondPointerPosition(t){let e=t.pointerId===this._pointers[0]?this._pointers[1]:this._pointers[0];return this._pointerPositions[e]}_customWheelEvent(t){let e=t.deltaMode,n={clientX:t.clientX,clientY:t.clientY,deltaY:t.deltaY};switch(e){case 1:n.deltaY*=16;break;case 2:n.deltaY*=100;break}return t.ctrlKey&&!this._controlActive&&(n.deltaY*=10),n}};function e0(i){this.enabled!==!1&&(this._pointers.length===0&&(this.domElement.setPointerCapture(i.pointerId),this.domElement.ownerDocument.addEventListener("pointermove",this._onPointerMove),this.domElement.ownerDocument.addEventListener("pointerup",this._onPointerUp)),!this._isTrackingPointer(i)&&(this._addPointer(i),i.pointerType==="touch"?this._onTouchStart(i):this._onMouseDown(i),this._cursorStyle==="grab"&&(this.domElement.style.cursor="grabbing")))}function n0(i){this.enabled!==!1&&(i.pointerType==="touch"?this._onTouchMove(i):this._onMouseMove(i))}function i0(i){switch(this._removePointer(i),this._pointers.length){case 0:this.domElement.releasePointerCapture(i.pointerId),this.domElement.ownerDocument.removeEventListener("pointermove",this._onPointerMove),this.domElement.ownerDocument.removeEventListener("pointerup",this._onPointerUp),this.dispatchEvent(Eu),this.state=pe.NONE,this._cursorStyle==="grab"&&(this.domElement.style.cursor="grab");break;case 1:let t=this._pointers[0],e=this._pointerPositions[t];this._onTouchStart({pointerId:t,pageX:e.x,pageY:e.y});break}}function s0(i){let t;switch(i.button){case 0:t=this.mouseButtons.LEFT;break;case 1:t=this.mouseButtons.MIDDLE;break;case 2:t=this.mouseButtons.RIGHT;break;default:t=-1}switch(t){case yn.DOLLY:if(this.enableZoom===!1)return;this._handleMouseDownDolly(i),this.state=pe.DOLLY;break;case yn.ROTATE:if(i.ctrlKey||i.metaKey||i.shiftKey){if(this.enablePan===!1)return;this._handleMouseDownPan(i),this.state=pe.PAN}else{if(this.enableRotate===!1)return;this._handleMouseDownRotate(i),this.state=pe.ROTATE}break;case yn.PAN:if(i.ctrlKey||i.metaKey||i.shiftKey){if(this.enableRotate===!1)return;this._handleMouseDownRotate(i),this.state=pe.ROTATE}else{if(this.enablePan===!1)return;this._handleMouseDownPan(i),this.state=pe.PAN}break;default:this.state=pe.NONE}this.state!==pe.NONE&&this.dispatchEvent(dc)}function r0(i){switch(this.state){case pe.ROTATE:if(this.enableRotate===!1)return;this._handleMouseMoveRotate(i);break;case pe.DOLLY:if(this.enableZoom===!1)return;this._handleMouseMoveDolly(i);break;case pe.PAN:if(this.enablePan===!1)return;this._handleMouseMovePan(i);break}}function a0(i){this.enabled===!1||this.enableZoom===!1||this.state!==pe.NONE||(i.preventDefault(),this.dispatchEvent(dc),this._handleMouseWheel(this._customWheelEvent(i)),this.dispatchEvent(Eu))}function o0(i){this.enabled!==!1&&this._handleKeyDown(i)}function l0(i){switch(this._trackPointer(i),this._pointers.length){case 1:switch(this.touches.ONE){case ai.ROTATE:if(this.enableRotate===!1)return;this._handleTouchStartRotate(i),this.state=pe.TOUCH_ROTATE;break;case ai.PAN:if(this.enablePan===!1)return;this._handleTouchStartPan(i),this.state=pe.TOUCH_PAN;break;default:this.state=pe.NONE}break;case 2:switch(this.touches.TWO){case ai.DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchStartDollyPan(i),this.state=pe.TOUCH_DOLLY_PAN;break;case ai.DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchStartDollyRotate(i),this.state=pe.TOUCH_DOLLY_ROTATE;break;default:this.state=pe.NONE}break;default:this.state=pe.NONE}this.state!==pe.NONE&&this.dispatchEvent(dc)}function c0(i){switch(this._trackPointer(i),this.state){case pe.TOUCH_ROTATE:if(this.enableRotate===!1)return;this._handleTouchMoveRotate(i),this.update();break;case pe.TOUCH_PAN:if(this.enablePan===!1)return;this._handleTouchMovePan(i),this.update();break;case pe.TOUCH_DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchMoveDollyPan(i),this.update();break;case pe.TOUCH_DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchMoveDollyRotate(i),this.update();break;default:this.state=pe.NONE}}function h0(i){this.enabled!==!1&&i.preventDefault()}function u0(i){i.key==="Control"&&(this._controlActive=!0,this.domElement.getRootNode().addEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}function d0(i){i.key==="Control"&&(this._controlActive=!1,this.domElement.getRootNode().removeEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}var gc=Bu(Tu(),1);function wu(i,t){let e=[];for(let n of t.legs){let s=i.get(n.edges[0]).points,r=s.slice(1).map((l,c)=>Math.hypot(l[0]-s[c][0],l[1]-s[c][1])),a=r.reduce((l,c)=>l+c,0),o=0;for(let l=1;l<s.length;l++){let c=r[l-1];c!==0&&(e.push({a:s[l-1],b:s[l],start:n.start+(n.end-n.start)*o/a,end:n.start+(n.end-n.start)*(o+c)/a}),o+=c)}}return e}function Au(i,t){let e=new Map;for(let n of i.stops)e.has(n.id)||e.set(n.id,{node:t.get(n.id),stops:[],events:[]}),e.get(n.id).stops.push(n);for(let n of i.events)e.get(n.LocationId)?.events.push(n);return[...e.values()].filter(n=>n.node)}function pc(i,t){let e=i.stops.filter(l=>l.arrival<=t.t).length,n=!t.leg&&t.stop.id===i.node.id,s=!t.done&&(t.leg?.b||t.upcoming?.LocationId)===i.node.id&&!n,r=n?"current":s?"next":e?"visited":"upcoming",a=i.events.filter(l=>l.t<=t.t).at(-1),o=a?.Summary.match(/\b(WEIGHTOK|WEIGHTERR|PENDING)\b|→\s*(NR|PF|ND)\b/);return{status:r,visits:e,last:a,result:o?.[1]||o?.[2]||"",caption:n?t.done?"Final stop":"Here now":s?"Next stop":e?"Visited":"Later on route"}}var p0={approachSeconds:3,approachDistance:150,graceSeconds:1.25,graceDistance:90};function Cu(i,t,e,n=p0){let s,r,a;if(!t.leg)r=i.stops.findLastIndex(l=>l.arrival<=t.t),s=i.stops[r],a="at-station";else{let l=e.get(t.leg.b),c=t.leg.end-t.t,h=Math.hypot(t.xy[0]-l.x,t.xy[1]-l.y);if(c<=n.approachSeconds&&h<=n.approachDistance)r=i.stops.findIndex(f=>f.id===t.leg.b&&Math.abs(f.arrival-t.leg.end)<.001),s=i.stops[r],a="approaching";else{r=i.stops.findLastIndex(u=>u.arrival<=t.leg.start),s=i.stops[r];let f=e.get(s.id);if(t.t-t.leg.start>n.graceSeconds||Math.hypot(t.xy[0]-f.x,t.xy[1]-f.y)>n.graceDistance)return null;a="departed-grace"}}if(!s)return null;let o=a==="approaching"?null:i.events.filter(l=>l.LocationId===s.id&&l.t>=s.arrival&&l.t<=t.t).at(-1)||null;return{node:e.get(s.id),stop:s,index:r,phase:a,last:o,next:i.stops[r+1]||null,visit:i.stops.slice(0,r+1).filter(l=>l.id===s.id).length,key:s.id+":"+s.arrival,remaining:a==="approaching"?s.arrival-t.t:Math.max(0,s.departure-t.t)}}function Ru(i,t=.9){let e=i.flatMap(([a,o])=>[[-1,-1],[-1,1],[1,-1],[1,1]].map(([l,c])=>[a+l*t,o+c*t])),n=[...new Map(e.map(a=>[a.join(","),a])).values()].sort((a,o)=>a[0]-o[0]||a[1]-o[1]),s=(a,o,l)=>(o[0]-a[0])*(l[1]-a[1])-(o[1]-a[1])*(l[0]-a[0]),r=a=>{let o=[];for(let l of a){for(;o.length>=2&&s(o.at(-2),o.at(-1),l)<=0;)o.pop();o.push(l)}return o.slice(0,-1)};return[...r(n),...r(n.toReversed())]}function mc(i,t,e){let n=[];for(let s=0;s<i.length;s++){let r=i[s],a=i[(s+1)%i.length];(r[t]<=e&&a[t]>e||a[t]<=e&&r[t]>e)&&n.push(r[1-t]+(a[1-t]-r[1-t])*(e-r[t])/(a[t]-r[t]))}return n.length>=2?[Math.min(...n),Math.max(...n)]:null}var Pt=i=>document.getElementById(i),No=i=>`${Math.floor(i/60).toString().padStart(2,"0")}:${Math.floor(i%60).toString().padStart(2,"0")}`,we=.02,di=(i,t=.5)=>new I(i[0]*we,t,i[1]*we),Pu=matchMedia("(prefers-reduced-motion: reduce)");async function m0(){let i=await fetch("/3d/model.json");if(!i.ok)throw new Error("The offline replay model could not be loaded.");let t=await i.json(),e=new Map(t.nodes.map(D=>[D.id,D])),n=new Map(t.edges.map(D=>[D.id,D])),s=Pt("viewport"),r=new Ro({antialias:!0,powerPreference:"high-performance"});r.setPixelRatio(Math.min(devicePixelRatio,1.5)),r.setClearColor(1055266),r.outputColorSpace=He,r.domElement.setAttribute("aria-label","Interactive 3D schematic conveyor plant"),s.append(r.domElement);let a=new Bs,o=new ri(-30,30,30,-30,.1,500),l=new Do(o,r.domElement);l.enableDamping=!1,l.mouseButtons.LEFT=yn.PAN,l.mouseButtons.RIGHT=yn.ROTATE,l.minPolarAngle=.005,l.maxPolarAngle=Math.PI*.47,l.minZoom=.45,l.maxZoom=12,l.screenSpacePanning=!0,a.add(new rr(13430527,2371897,2.5));let c=new or(16772558,3);c.position.set(-20,60,-30),a.add(c);let h=new hn(1,1,1),f=new Map,u=new Ce;function d(D,j,at,vt,Rt,x,R,k=0){f.has(D)||f.set(D,[]),f.get(D).push([j,at,vt,Rt,x,R,k])}let _=[["ENTRY & QUALITY",8,-12,20,2.5,2242109],["SEALING",15,2.7,43,13.8,2437435],["PACKAGING",7,15,37,26.8,2634553],["HALL 04",3.2,29.5,36,36,2177082],["HALL 03",3.2,36.7,36,42.8,2175033],["HALL 02",3.2,43.5,39,49,2437691]],M=new cn,m=[...t.nodes.map(D=>[D.x*we,D.y*we]),...t.edges.flatMap(D=>D.points.map(j=>[j[0]*we,j[1]*we])),..._.flatMap(([,D,j,at,vt])=>[[D,j],[D,vt],[at,j],[at,vt]])],p=Ru(m);for(let D of t.nodes)M.expandByPoint(di([D.x,D.y],1.3));for(let D of t.edges)for(let j of D.points)M.expandByPoint(di(j,0));for(let[,D,j,at,vt]of _)M.expandByPoint(new I(D,0,j)),M.expandByPoint(new I(at,0,vt));M.expandByVector(new I(.9,.2,.9));let w=M.getCenter(new I),A=new ei({color:1451310,roughness:1}),v=new as(p.map(([D,j])=>new ut(D,-j))),b=new be(new tr(v,{depth:.16,bevelEnabled:!1}),A);b.rotation.x=-Math.PI/2,b.position.y=-.48,a.add(b);for(let[,D,j,at,vt,Rt]of _)d(Rt,(D+at)/2,-.27,(j+vt)/2,at-D,.12,vt-j);let E=[];for(let D=Math.ceil(M.min.x);D<=M.max.x;D++){let j=mc(p,0,D);j&&E.push(new I(D,-.19,j[0]),new I(D,-.19,j[1]))}for(let D=Math.ceil(M.min.z);D<=M.max.z;D++){let j=mc(p,1,D);j&&E.push(new I(j[0],-.19,D),new I(j[1],-.19,D))}let L=new Hs(new We().setFromPoints(E),new ss({color:4413304,transparent:!0,opacity:.16}));a.add(L);let y=new Map,T=new Map;for(let D of t.edges)for(let j=1;j<D.points.length;j++){let at=D.points[j-1],vt=D.points[j],Rt=[at.join(","),vt.join(",")].sort().join("|");T.has(Rt)||T.set(Rt,[at,vt])}for(let[D,j]of T.values()){let at=(j[0]-D[0])*we,vt=(j[1]-D[1])*we,Rt=Math.hypot(at,vt);if(Rt<.001)continue;let x=(D[0]+j[0])*we/2,R=(D[1]+j[1])*we/2,k=Math.atan2(at,vt);d(3426130,x,.05,R,.55,.33,Rt,k),d(5796218,x,.235,R,.4,.065,Rt,k);let z=Math.cos(k)*.27,O=-Math.sin(k)*.27;for(let lt of[-1,1])d(8098197,x+z*lt,.29,R+O*lt,.045,.13,Rt,k);for(let lt=.35;lt<Rt;lt+=.65){let ft=lt/Rt;d(7505801,D[0]*we+at*ft,.279,D[1]*we+vt*ft,.38,.025,.028,k)}for(let lt=.4;lt<Rt;lt+=3){let ft=lt/Rt;d(2504256,D[0]*we+at*ft,-.09,D[1]*we+vt*ft,.42,.4,.12,k)}}let C={scanner:6929663,scale:15451243,decision:10980346,sealer:2278816,strapper:2278816,printer:15759424,exit:8703110,exception:15689334,junction:9413566},F=[];for(let D of t.nodes){let j=D.x*we,at=D.y*we,vt=C[D.kind];D.kind==="scanner"||D.kind==="decision"?(d(vt,j-.39,.68,at,.1,.85,.16),d(vt,j+.39,.68,at,.1,.85,.16),d(vt,j,1.1,at,.88,.12,.18),d(1518389,j,.97,at,.21,.12,.2)):D.kind==="sealer"||D.kind==="strapper"||D.kind==="printer"?(d(vt,j-.42,.55,at,.22,1.05,.68),d(vt,j+.42,.55,at,.22,1.05,.68),d(vt,j,1.1,at,1.06,.18,.7),d(1518389,j+.43,.83,at-.355,.13,.22,.03)):D.kind==="scale"?(d(vt,j,.28,at,.73,.16,.68),d(2571076,j+.4,.55,at,.09,.65,.08),d(vt,j+.4,.87,at,.25,.2,.12)):(d(vt,j,.28,at,.68,.12,.68),(D.kind==="exit"||D.kind==="exception")&&d(vt,j,.07,at+.32,.73,.3,1.1));let Rt=new be(new hn(1.1,1.3,1.1),new An({visible:!1}));Rt.position.set(j,.6,at),Rt.userData.node=D,a.add(Rt),F.push(Rt)}for(let[D,j]of f){let at=new ns(h,new ei({color:D,roughness:.78,metalness:.15}),j.length);j.forEach(([vt,Rt,x,R,k,z,O],lt)=>{u.position.set(vt,Rt,x),u.scale.set(R,k,z),u.rotation.set(0,O,0),u.updateMatrix(),at.setMatrixAt(lt,u.matrix)}),at.computeBoundingSphere(),a.add(at),y.set(D,at.material)}let H=_.map(([D,j,at,vt,Rt])=>{let x=document.createElement("span");return x.className="section-label",x.textContent=D,Pt("section-labels").append(x),{el:x,point:D==="ENTRY & QUALITY"?new I(j+4,.35,at+.5):new I(vt-3,.35,Rt-.45)}}),W=new Bn,U=new be(new hn(.55,.46,.65),new ei({color:16103534,roughness:.85})),V=new be(new hn(.12,.465,.655),new ei({color:16768941})),K=new be(new hn(.18,.01,.22),new An({color:16774620}));K.position.set(.16,.237,-.1),W.add(U,V,K),a.add(W);let q=new be(new nr(.46,.54,32),new An({color:16761985,side:un,transparent:!0,opacity:.9,depthWrite:!1}));q.rotation.x=-Math.PI/2,a.add(q);let rt=new ns(h,new An({color:16759672}),1024);rt.instanceMatrix.setUsage(kl),rt.frustumCulled=!1,rt.count=0,a.add(rt);let Y=[],nt=-1,st=-1;function Ot(D){if(Y=wu(n,D),Y.length>rt.instanceMatrix.count)throw new Error("Replay exceeds the trail capacity.");rt.count=0,nt=-1,st=-1}function Lt(D,j){let{a:at,b:vt}=Y[D],Rt=(vt[0]-at[0])*we*j,x=(vt[1]-at[1])*we*j;u.position.set(at[0]*we+Rt/2,.325,at[1]*we+x/2),u.scale.set(.105,.035,Math.max(1e-5,Math.hypot(Rt,x))),u.rotation.set(0,Math.atan2(Rt,x),0),u.updateMatrix(),rt.setMatrixAt(D,u.matrix)}function le(D){let j=0;for(;j<Y.length&&Y[j].start<D;)j++;j<nt&&(nt=-1,st=-1);for(let at=Math.max(0,nt-1);at<j;at++)Lt(at,1);if(j){let at=Y[j-1],vt=Math.min(1,(D-at.start)/(at.end-at.start));(vt<1||st===j-1)&&Lt(j-1,vt),st=vt<1?j-1:-1}rt.count=j,rt.instanceMatrix.needsUpdate=!0,nt=j}let Bt=t.parcels[0],$t=0,X=!1,it=!1,Et=!1,Gt=performance.now(),At=-1/0,Yt=-1,It,J=null,ot=0,ct=!0,ht=!1,mt=0,Ht=performance.now(),Vt=0,Zt=[],Kt=!0,P=36,ne={};function Wt(){ct=!0,!ot&&!ht&&(ot=requestAnimationFrame(vs))}function S(D){it=D,Pt("follow").classList.toggle("selected",D),Pt("follow").setAttribute("aria-pressed",String(D))}function g(D){let j=D.clone().sub(l.target);o.position.add(j),l.target.copy(D),l.update()}function B(){let D=document.querySelector(".view-tools");return D.offsetTop+D.offsetHeight+12}function G(){o.zoom=1,o.updateMatrixWorld(!0);let D=[];for(let[Jt,Qt]of p)for(let bt of[0,1.5])D.push(new I(Jt,bt,Qt).applyMatrix4(o.matrixWorldInverse));let j=D.map(Jt=>Jt.x),at=D.map(Jt=>Jt.y),vt=s.clientWidth,Rt=s.clientHeight,x=Math.min(...j),R=Math.max(...j),k=Math.min(...at),z=Math.max(...at),O=Math.max(1,vt-32),lt=Math.max(1,Rt-B()-35),ft=Math.max((R-x)/O,(z-k)/lt)*1.04;P=ft*Rt/2;let pt=new I().setFromMatrixColumn(o.matrixWorld,0),Tt=new I().setFromMatrixColumn(o.matrixWorld,1),Dt=pt.multiplyScalar((x+R)/2).add(Tt.multiplyScalar((k+z)/2+(B()-35)*ft/2));o.position.add(Dt),l.target.add(Dt),o.left=-ft*vt/2,o.right=ft*vt/2,o.top=P,o.bottom=-P,o.updateProjectionMatrix(),l.update(),Wt()}function Z(D,j=!1){Et=D,Pt("iso").classList.toggle("selected",!D),Pt("top").classList.toggle("selected",D),Pt("iso").setAttribute("aria-pressed",String(!D)),Pt("top").setAttribute("aria-pressed",String(D)),j&&(S(!1),l.target.copy(w),o.zoom=1,Kt=!0);let at=D?new I(0,85,.01):new I(14,90,65);o.position.copy(l.target).add(at),o.updateProjectionMatrix(),l.update(),Kt&&G(),Wt()}function dt(){let D=s.clientWidth,j=s.clientHeight;r.setSize(D,j),Kt?G():(o.left=-P*D/j,o.right=P*D/j,o.top=P,o.bottom=-P,o.updateProjectionMatrix(),Wt())}new ResizeObserver(dt).observe(s),l.addEventListener("change",Wt),l.addEventListener("start",()=>{S(!1),Kt=!1});let _t=new lr,$=new ut,Q=null,gt=null,Ft=!1,St=0;function Mt(D,j){let at=s.getBoundingClientRect();return $.set((D-at.left)/at.width*2-1,-(j-at.top)/at.height*2+1),_t.setFromCamera($,o),_t.intersectObjects(F,!1)[0]?.object.userData.node||null}s.addEventListener("pointerdown",D=>{Q=[D.clientX,D.clientY]}),s.addEventListener("pointermove",D=>{if(D.buttons){Ft=!0,J=null;return}gt=[D.clientX,D.clientY],Wt()}),s.addEventListener("pointerleave",()=>{J=null,gt=null,Wt()}),s.addEventListener("pointerup",D=>{if(Ft=!1,!Q||Math.hypot(D.clientX-Q[0],D.clientY-Q[1])>5){Q=null;return}Q=null,J=Mt(D.clientX,D.clientY),J&&Pi(J),Wt()}),s.addEventListener("pointercancel",()=>{Q=null,Ft=!1,J=null});let kt=Pt("route-labels"),Xt=Pt("route-leaders"),te={scanner:"Scanner",scale:"Weight check",decision:"Routing decision",sealer:"Processing",strapper:"Strapper",printer:"Label printer",exit:"Exit",exception:"Exception",junction:"Transfer"},N=new Map,xt=null,tt="",yt="",Ct=140,et=document.createElement("button");et.className="station-callout",et.tabIndex=-1;let zt=document.createElement("span"),Ut=document.createElement("strong"),de=document.createElement("small"),ce=document.createElement("p"),ze=document.createElement("p");zt.className="callout-phase",ze.className="callout-next",et.append(zt,Ut,de,ce,ze),kt.append(et);let ke=document.createElementNS("http://www.w3.org/2000/svg","path");ke.classList.add("context-leader"),Xt.append(ke);let _s=null;et.onclick=()=>{_s&&Pi(_s.node)};let Ri=D=>{let j=D.clone().project(o);return{x:(j.x+1)/2*s.clientWidth,y:(1-j.y)/2*s.clientHeight,depth:j.z}};function Pi(D){xt=D,Pt("station-detail").hidden=!1,Pt("station-title").textContent=D.label,Pt("station-code").textContent=`${D.id}${D.equipment?" \xB7 "+D.equipment:""} \xB7 ${te[D.kind]||D.kind}`;let j=N.get(D.id),at=j?pc(j,It):null;Pt("station-result").textContent=at?at.last?`${No(at.last.t)} \xB7 ${at.last.Summary}
${at.last.Timestamp||""}
${(at.last.Evidence||[]).map(vt=>vt.FileName+":"+vt.LineNumber+`
`+vt.RawLine).join(`
`)}`:"Later on this recorded route. No event has occurred here yet.":"Not on the selected parcel\u2019s route.",Pt("station-visits").textContent=at?`${at.visits} visit${at.visits===1?"":"s"} so far${at.result?" \xB7 "+at.result:""}`:""}Pt("station-close").onclick=()=>{xt=null,Pt("station-detail").hidden=!0};function xs(){N=new Map(Au(Bt,e).map(D=>[D.node.id,D])),tt="",yt="",et.classList.remove("visible"),et.tabIndex=-1}function Uo(){let D=Cu(Bt,It,e);_s=D;let j=s.clientWidth,at=s.clientHeight,vt=B();xt&&Pi(xt);let Rt=D?Ri(di([D.node.x,D.node.y],1.1)):null,x=Rt&&Rt.depth>=-1&&Rt.depth<=1&&Rt.x>=0&&Rt.x<=j&&Rt.y>=vt&&Rt.y<=at-30;et.classList.toggle("visible",!!x),et.tabIndex=x?0:-1,et.setAttribute("aria-hidden",String(!x)),ke.style.display=x?"":"none";let R=null;if(x){let z=[D.key,D.phase,D.last?.t,Math.ceil(D.remaining),It.done].join("|");if(z!==yt){zt.textContent=D.phase==="approaching"?"APPROACHING \xB7 "+Math.ceil(D.remaining)+"s":D.phase==="departed-grace"?"JUST PASSED":It.done?"FINAL STATION":"AT STATION",Ut.textContent=D.node.label,de.textContent=[te[D.node.kind]||D.node.kind,D.node.equipment||D.node.id,"Visit "+D.visit].join(" \xB7 "),ce.textContent=D.last?.Summary||(D.phase==="approaching"?"Awaiting this station\u2019s event.":"No recorded event yet."),ze.textContent=D.next?"Next \u2192 "+e.get(D.next.id).label:"End of the recorded journey";let bt=/WEIGHTERR|→\\s*(NR|PF|ND)\\b|NIO/.test(D.last?.Summary||"");et.dataset.tone=bt?"exception":/PENDING/.test(D.last?.Summary||"")?"warning":"active",D.key!==tt&&X&&!Pu.matches&&(et.getAnimations().forEach(oe=>oe.cancel()),et.animate([{opacity:0},{opacity:1}],{duration:160})),tt=D.key,yt=z,Ct=et.offsetHeight}let O=et.offsetWidth,lt=Ct,ft=Ri(W.position),pt=[{x:Rt.x-O/2,y:Rt.y-lt-40},{x:Rt.x+24,y:Rt.y-lt/2},{x:Rt.x-O-24,y:Rt.y-lt/2},{x:Rt.x-O/2,y:Rt.y+60}],Tt=bt=>({x:Math.max(10,Math.min(j-O-10,bt.x)),y:Math.max(vt,Math.min(at-lt-30,bt.y))}),Dt=pt.map(Tt),Jt=bt=>(ft.x>bt.x-25&&ft.x<bt.x+O+25&&ft.y>bt.y-35&&ft.y<bt.y+lt+20?1e4:0)+Math.hypot(bt.x+O/2-Rt.x,bt.y+lt/2-Rt.y);Dt.sort((bt,oe)=>Jt(bt)-Jt(oe));let Qt=Dt[0];R={...Qt,w:O,h:lt},et.style.left=Qt.x+"px",et.style.top=Qt.y+"px",ke.setAttribute("d","M"+Rt.x+","+Rt.y+" L"+Math.max(Qt.x,Math.min(Qt.x+O,Rt.x))+","+Math.max(Qt.y,Math.min(Qt.y+lt,Rt.y)))}let k=[];for(let z of H){let O=Ri(z.point),lt=z.el.offsetWidth||96,ft=22,pt=O.x-lt/2,Tt=O.y;k.some(Jt=>Math.abs(Jt.x-pt)<lt&&Math.abs(Jt.y-Tt)<ft)&&(Tt+=ft+3);let Dt=R&&pt<R.x+R.w&&pt+lt>R.x&&Tt<R.y+R.h&&Tt+ft>R.y;z.el.hidden=O.depth<-1||O.depth>1||pt<8||pt+lt>j-8||Tt<vt||Tt+ft>at-30||!!Dt,z.el.style.transform="translate("+pt+"px,"+Tt+"px)",k.push({x:pt,y:Tt})}}function Sr(D,j,at){let vt=Pt(D);if(!j){vt.style.display="none";return}let Rt=j.clone().project(o),x=(Rt.x+1)/2*s.clientWidth,R=(1-Rt.y)/2*s.clientHeight-20;if(Rt.z<-1||Rt.z>1||x<90||x>s.clientWidth-90||R<B()||R>s.clientHeight-50){vt.style.display="none";return}vt.style.display="block",vt.style.left=`${x}px`,vt.style.top=`${R}px`,vt.textContent!==at&&(vt.textContent=at)}function br(D){Sr("tag-current",W.position,Bt.id),Uo(D);let j=Pt("tag-hover");if(!J){j.style.display="none";return}let at=Ri(di([J.x,J.y],1.5)),vt=N.get(J.id),Rt=vt?pc(vt,It):null;j.textContent=`${J.label}
${te[J.kind]||J.kind} \xB7 ${J.id}${J.equipment?" \xB7 "+J.equipment:""}
${Rt?.last?.Summary||(vt?"Later on selected route":"Not on this parcel\u2019s route")}
Click equipment for details`,j.style.display="block",j.style.left=`${Math.max(150,Math.min(s.clientWidth-150,at.x))}px`,j.style.top=`${Math.max(310,Math.min(s.clientHeight-40,at.y-20))}px`}function In(){let D=It.done?It.phase.toUpperCase():It.leg?"IN TRANSIT":"AT EQUIPMENT";Pt("state-badge").textContent=D,Pt("percent").textContent=`${Math.floor($t/Bt.duration*100)}%`,Pt("progress-fill").style.width=`${$t/Bt.duration*100}%`,Pt("current").textContent=It.done?Bt.completeness:It.leg?"Conveyor transfer":e.get(It.stop.id).label,Pt("description").textContent=It.leg?`${e.get(It.leg.a).label} \u2192 ${e.get(It.leg.b).label}`:It.event.Summary,Pt("next").textContent=It.done?"End of this replay":e.get(It.leg?.b||It.nextStop?.id)?.label||"Final operation",Pt("expectation").textContent=It.next,Pt("seek").value=$t,Pt("time").textContent=No($t),Yt!==It.index&&(Zt.forEach((j,at)=>{j.classList.toggle("active",at===It.index),j.classList.toggle("past",at<It.index),j.setAttribute("aria-current",at===It.index?"step":"false")}),Yt=It.index),Pt("play").textContent=X?"\u2161 Pause":"\u25B6 Play"}function ys(){It=gc.default.sample(t,Bt,$t),W.position.copy(di(It.xy,.535)),q.position.copy(di(It.xy,.3));let D=It.done?It.phase==="completed"?ne.success:It.phase==="held"?ne.warning:ne.exception:ne.trace;if(q.material.color.set(D),rt.material.color.set(D),It.leg){let j=n.get(It.leg.edges[0]),at=Math.min(1,($t-It.leg.start)/(It.leg.end-It.leg.start)+1e-4),vt=gc.default.at(j.points,at),Rt=vt[0]-It.xy[0],x=vt[1]-It.xy[1];Math.hypot(Rt,x)>1e-5&&(W.rotation.y=Math.atan2(Rt,x))}le($t),it&&g(di(It.xy,0))}function vs(D){ot=0,ht=!0;try{X&&!document.hidden&&($t=Math.min(Bt.duration,$t+(D-Gt)/1e3*Number(Pt("speed").value)),$t>=Bt.duration&&(X=!1),ct=!0),Gt=D,ct&&(ys(),(D-At>=100||!X)&&(In(),At=D),gt&&!Ft&&D-St>=60&&(J=Mt(...gt),gt=null,St=D),br(D),r.render(a,o),ct=!1,mt++,X||(Pt("render-info").textContent=`PAUSED \xB7 ${r.info.render.calls} DRAW CALLS`),X&&D-Ht>=1e3&&(Vt=Math.round(mt*1e3/(D-Ht)),Pt("render-info").textContent=`${Vt} FPS \xB7 ${r.info.render.calls} DRAW CALLS`,mt=0,Ht=D)),ht=!1,(X||gt)&&!document.hidden&&!ot&&(ct=!0,ot=requestAnimationFrame(vs))}catch(j){ht=!1,X=!1,_c(j)}}function fi(){X=!1,Wt()}function Ln(D){fi(),$t=Math.max(0,Math.min(Bt.duration,D)),At=-1/0,Wt()}function pi(D){fi(),Bt=t.parcels[D],$t=0,Yt=-1,J=null,xt=null,gt=null,Pt("station-detail").hidden=!0,Ot(Bt),xs(),At=-1/0,Pt("scenario").value=D,Pt("parcel-id").textContent=Bt.id,Pt("parcel-name").textContent=Bt.name,Pt("seek").max=Bt.duration,Pt("duration").textContent=No(Bt.duration),Pt("event-count").textContent=`${Bt.events.length} events`,Zt.length=0,Pt("timeline").replaceChildren(),Bt.events.forEach((j,at)=>{let vt=document.createElement("button");vt.className="event",vt.title=j.Summary;let Rt=document.createElement("time");Rt.textContent=No(j.t);let x=document.createElement("span");x.textContent=e.get(j.LocationId).label,vt.append(Rt,x),vt.onclick=()=>Ln(j.t),Zt.push(vt),Pt("timeline").append(vt)}),Wt()}t.parcels.forEach((D,j)=>{let at=document.createElement("option");at.value=j,at.textContent=`${D.id} \xB7 ${D.name}`,Pt("scenario").append(at)}),Pt("scenario").onchange=()=>pi(Number(Pt("scenario").value)),Pt("search-form").onsubmit=D=>{D.preventDefault();let j=t.parcels.findIndex(at=>[at.id,...at.aliases||[]].some(vt=>vt.toLowerCase()===Pt("search").value.trim().toLowerCase()));Pt("search-status").textContent=j<0?"Parcel ID not found.":"",j>=0&&pi(j)},Pt("play").onclick=()=>{$t>=Bt.duration&&($t=0,Ot(Bt)),X=!X,Gt=performance.now(),Ht=Gt,mt=0,At=-1/0,Wt()},Pt("restart").onclick=()=>pi(Number(Pt("scenario").value)),Pt("seek").oninput=()=>Ln(Number(Pt("seek").value)),Pt("previous").onclick=()=>Ln([...Bt.events].reverse().find(D=>D.t<$t-.001)?.t??0),Pt("next-event").onclick=()=>Ln(Bt.events.find(D=>D.t>$t+.001)?.t??Bt.duration),Pt("speed").onchange=()=>{Gt=performance.now(),Wt()},Pt("iso").onclick=()=>Z(!1),Pt("top").onclick=()=>Z(!0),Pt("fit").onclick=()=>Z(Et,!0),Pt("focus").onclick=()=>{Kt=!1,o.zoom=3,o.updateProjectionMatrix(),g(di(It.xy,0)),S(!0),Wt()},Pt("follow").onclick=()=>{S(!it),Wt()},document.addEventListener("visibilitychange",()=>{document.hidden&&fi(),Gt=performance.now()}),document.addEventListener("keydown",D=>{["INPUT","SELECT","BUTTON","TEXTAREA"].includes(D.target.tagName)||(D.code==="Space"&&(D.preventDefault(),Pt("play").click()),D.key==="Home"&&Pt("fit").click())}),r.domElement.addEventListener("webglcontextlost",D=>{D.preventDefault(),fi(),_c(new Error("The graphics context was lost. Reload this page or use the 2D viewer."))}),Pu.addEventListener("change",Wt);let mi=matchMedia("(prefers-color-scheme: light)"),qe="system";try{qe=localStorage.getItem("parceljourney-theme")||"system"}catch{}function gi(){let D=qe==="light"||qe==="system"&&mi.matches;document.body.classList.toggle("light",D),document.body.dataset.theme=D?"light":"dark",Pt("theme").textContent="Theme: "+qe;let j=getComputedStyle(document.body);ne=Object.fromEntries(["map","surface","control","line","tube","trace","success","warning","exception"].map(at=>[at,j.getPropertyValue("--"+at).trim()])),r.setClearColor(ne.map),A.color.set(ne.tube),L.material.color.set(ne.line);for(let[at,vt]of y)_.some(Rt=>Rt[5]===at)?vt.color.set(ne.surface).lerp(new se(ne.tube),.65):[3426130,2504256,1518389,2571076].includes(at)?vt.color.set(ne.control):[5796218,8098197,7505801].includes(at)&&vt.color.set(D?"#7899b5":"#526b89");U.material.color.set(ne.trace),Wt()}Pt("theme").onclick=()=>{qe=qe==="system"?"light":qe==="light"?"dark":"system";try{qe==="system"?localStorage.removeItem("parceljourney-theme"):localStorage.setItem("parceljourney-theme",qe)}catch{}gi()},mi.addEventListener("change",()=>{qe==="system"&&gi()}),addEventListener("storage",D=>{D.key==="parceljourney-theme"&&(qe=D.newValue||"system",gi())}),gi(),dt(),Z(!1,!0),pi(0),Pt("scenario").disabled=!1,Pt("play").disabled=!1,Pt("loading").hidden=!0}function _c(i){Pt("loading").hidden=!0,Pt("error").hidden=!1,Pt("error-message").textContent=i.message||"WebGL2 is required for this view.",console.error(i)}m0().catch(_c);})();
